...
`).map(IA).filter(y=>y!==null),s=t.filter(y=>y.type===kl.BODY_LINE).map(y=>y.body),r=s.findIndex(y=>y.lyrics||y.chords.length),u=s.length-s.slice().reverse().findIndex(y=>y.lyrics||y.chords.length),d=s.slice(r,u),m=t.filter(y=>y.type===kl.DIRECTIVE).reduce((y,h)=>({...y,[h.directive]:h.value}),{});return m.title===void 0||m.number===void 0?null:{title:m.title,number:m.number,latinTitle:Lh(m.title||""),body:d}},eC=o=>{let t=0;for(let s=0;s<o.length;s++)t=(t<<5)-t+o.charCodeAt(s),t=t&65535;return t.toString(16).toUpperCase().padStart(4,"0")},nC=o=>({songs:o.split(/---\s*\n/).map($A).filter(s=>s!==null),checksum:eC(o)}),aC=()=>{const o=nC(VA);return R.jsx(XA,{parsedSongbook:o})};var yu={exports:{}},Bo={},wu={exports:{}},hu={};var hw;function iC(){return hw||(hw=1,(function(o){function t(E,P){var J=E.length;E.push(P);e:for(;0<J;){var re=J-1>>>1,me=E[re];if(0<u(me,P))E[re]=P,E[J]=me,J=re;else break e}}function s(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var P=E[0],J=E.pop();if(J!==P){E[0]=J;e:for(var re=0,me=E.length,b=me>>>1;re<b;){var O=2*(re+1)-1,H=E[O],F=O+1,ae=E[F];if(0>u(H,J))F<me&&0>u(ae,H)?(E[re]=ae,E[F]=J,re=F):(E[re]=H,E[O]=J,re=O);else if(F<me&&0>u(ae,J))E[re]=ae,E[F]=J,re=F;else break e}}return P}function u(E,P){var J=E.sortIndex-P.sortIndex;return J!==0?J:E.id-P.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;o.unstable_now=function(){return d.now()}}else{var m=Date,y=m.now();o.unstable_now=function(){return m.now()-y}}var h=[],w=[],v=1,k=null,B=3,_=!1,L=!1,U=!1,ee=!1,q=typeof setTimeout=="function"?setTimeout:null,W=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;function ue(E){for(var P=s(w);P!==null;){if(P.callback===null)r(w);else if(P.startTime<=E)r(w),P.sortIndex=P.expirationTime,t(h,P);else break;P=s(w)}}function Y(E){if(U=!1,ue(E),!L)if(s(h)!==null)L=!0,ce||(ce=!0,$());else{var P=s(w);P!==null&&He(Y,P.startTime-E)}}var ce=!1,Q=-1,Oe=5,Qe=-1;function dn(){return ee?!0:!(o.unstable_now()-Qe<Oe)}function rn(){if(ee=!1,ce){var E=o.unstable_now();Qe=E;var P=!0;try{e:{L=!1,U&&(U=!1,W(Q),Q=-1),_=!0;var J=B;try{n:{for(ue(E),k=s(h);k!==null&&!(k.expirationTime>E&&dn());){var re=k.callback;if(typeof re=="function"){k.callback=null,B=k.priorityLevel;var me=re(k.expirationTime<=E);if(E=o.unstable_now(),typeof me=="function"){k.callback=me,ue(E),P=!0;break n}k===s(h)&&r(h),ue(E)}else r(h);k=s(h)}if(k!==null)P=!0;else{var b=s(w);b!==null&&He(Y,b.startTime-E),P=!1}}break e}finally{k=null,B=J,_=!1}P=void 0}}finally{P?$():ce=!1}}}var $;if(typeof I=="function")$=function(){I(rn)};else if(typeof MessageChannel<"u"){var _e=new MessageChannel,je=_e.port2;_e.port1.onmessage=rn,$=function(){je.postMessage(null)}}else $=function(){q(rn,0)};function He(E,P){Q=q(function(){E(o.unstable_now())},P)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(E){E.callback=null},o.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Oe=0<E?Math.floor(1e3/E):5},o.unstable_getCurrentPriorityLevel=function(){return B},o.unstable_next=function(E){switch(B){case 1:case 2:case 3:var P=3;break;default:P=B}var J=B;B=P;try{return E()}finally{B=J}},o.unstable_requestPaint=function(){ee=!0},o.unstable_runWithPriority=function(E,P){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var J=B;B=E;try{return P()}finally{B=J}},o.unstable_scheduleCallback=function(E,P,J){var re=o.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?re+J:re):J=re,E){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=J+me,E={id:v++,callback:P,priorityLevel:E,startTime:J,expirationTime:me,sortIndex:-1},J>re?(E.sortIndex=J,t(w,E),s(h)===null&&E===s(w)&&(U?(W(Q),Q=-1):U=!0,He(Y,J-re))):(E.sortIndex=me,t(h,E),L||_||(L=!0,ce||(ce=!0,$()))),E},o.unstable_shouldYield=dn,o.unstable_wrapCallback=function(E){var P=B;return function(){var J=B;B=P;try{return E.apply(this,arguments)}finally{B=J}}}})(hu)),hu}var pw;function tC(){return pw||(pw=1,wu.exports=iC()),wu.exports}var bw;function oC(){if(bw)return Bo;bw=1;var o=tC(),t=Fu(),s=jw();function r(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function d(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function m(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function y(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function h(e){if(d(e)!==e)throw Error(r(188))}function w(e){var n=e.alternate;if(!n){if(n=d(e),n===null)throw Error(r(188));return n!==e?null:e}for(var a=e,i=n;;){var l=a.return;if(l===null)break;var c=l.alternate;if(c===null){if(i=l.return,i!==null){a=i;continue}break}if(l.child===c.child){for(c=l.child;c;){if(c===a)return h(l),e;if(c===i)return h(l),n;c=c.sibling}throw Error(r(188))}if(a.return!==i.return)a=l,i=c;else{for(var f=!1,z=l.child;z;){if(z===a){f=!0,a=l,i=c;break}if(z===i){f=!0,i=l,a=c;break}z=z.sibling}if(!f){for(z=c.child;z;){if(z===a){f=!0,a=c,i=l;break}if(z===i){f=!0,i=c,a=l;break}z=z.sibling}if(!f)throw Error(r(189))}}if(a.alternate!==i)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?e:n}function v(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=v(e),n!==null)return n;e=e.sibling}return null}var k=Object.assign,B=Symbol.for("react.element"),_=Symbol.for("react.transitional.element"),L=Symbol.for("react.portal"),U=Symbol.for("react.fragment"),ee=Symbol.for("react.strict_mode"),q=Symbol.for("react.profiler"),W=Symbol.for("react.consumer"),I=Symbol.for("react.context"),ue=Symbol.for("react.forward_ref"),Y=Symbol.for("react.suspense"),ce=Symbol.for("react.suspense_list"),Q=Symbol.for("react.memo"),Oe=Symbol.for("react.lazy"),Qe=Symbol.for("react.activity"),dn=Symbol.for("react.memo_cache_sentinel"),rn=Symbol.iterator;function $(e){return e===null||typeof e!="object"?null:(e=rn&&e[rn]||e["@@iterator"],typeof e=="function"?e:null)}var _e=Symbol.for("react.client.reference");function je(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===_e?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case U:return"Fragment";case q:return"Profiler";case ee:return"StrictMode";case Y:return"Suspense";case ce:return"SuspenseList";case Qe:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case L:return"Portal";case I:return e.displayName||"Context";case W:return(e._context.displayName||"Context")+".Consumer";case ue:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case Q:return n=e.displayName||null,n!==null?n:je(e.type)||"Memo";case Oe:n=e._payload,e=e._init;try{return je(e(n))}catch{}}return null}var He=Array.isArray,E=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,P=s.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,J={pending:!1,data:null,method:null,action:null},re=[],me=-1;function b(e){return{current:e}}function O(e){0>me||(e.current=re[me],re[me]=null,me--)}function H(e,n){me++,re[me]=e.current,e.current=n}var F=b(null),ae=b(null),oe=b(null),we=b(null);function Xe(e,n){switch(H(oe,n),H(ae,e),H(F,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?Sz(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=Sz(n),e=Gz(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}O(F),H(F,e)}function Se(){O(F),O(ae),O(oe)}function On(e){e.memoizedState!==null&&H(we,e);var n=F.current,a=Gz(n,e.type);n!==a&&(H(ae,e),H(F,a))}function na(e){ae.current===e&&(O(F),O(ae)),we.current===e&&(O(we),To._currentValue=J)}var Xn,Ea;function mn(e){if(Xn===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Xn=n&&n[1]||"",Ea=-1<a.stack.indexOf(`
