...
a7 D G
Przed Twym tronem, dziś Najwyższy składam hołd!`,pA=`Ref. Chrystus Pan karmi nas [e] [C] [h7]
...
Ref. Duchu Święty…
`,JA=`Ref. Duchu Święty, Boże przyjdź,    [g] [d]
...
chcę iść za Tobą Duchu Święty. [C] [D] [e]
`,LA=`/x2/ Duchu Święty, Duchu Święty [a] [F7+] [d] [E7]
...
`,KA=`Duchu Święty, Stworzycielu [B]
...
`,JC=`Jezus, Jezus, Jezus, Jezus, Jezus [D] [E7] [G] [A7] [D]
...
`,LC=`1. My, którzy wszystko liczymy, [h]
...
Ref. Każdy wschód słońca…
`,KC=`Ref: Kiedyś wino i chleb [D] [G] [A]
...
`,FD=`O Jezu, cichy i pokorny         [d] [a] [d] [a]
Uczyń serce me                  [F] [a]
...
`,KD=`1. O, Panie, Ty nam dajesz [d] [F]
...
`,K2=`1. Skrzypi wóz, wielki mróz,  [F] [B]
