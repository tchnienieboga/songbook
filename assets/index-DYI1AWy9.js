...
`,bA=`Chwała Bogu Ojcu, w chwale Jego Syn [e] [D] [e] [D]
Chwała Tobie Duchu, [e] [D/Fis]
tworzysz jedno w Nich. [C/G] [D/A] [e/H]
`,jA=`Ref. Chwała na wysokości! [A] [D] [E]
...
Ref. Chwała na wysokości!...
`,vA=`Ref. Ooo... Chwała Panu i cześć [C] [G] [a] [C] [F] [G] [D] [A] [h] [D] [G] [A]
...
`,kA=`Ref. Chwalcie Pana Niebios [e]
...
Odkupienie win...
Odkupienie win.
`,AA=`Ciebie pragnie dusza moja [h] [G] [D] [A]
...
`,TA=`1. Cóż to za Dziecię słodko śpi   [d] [F] [C] [a]
...
`,EA=`1. Czekam na Ciebie, dobry Boże, [a] [d]
...
Przyjdź i nie spóźniaj się.
`,SA=`1. Daj mi usłyszeć Twój głos, rozpoznać go. [G] [D]
...
`,OA=`1. Do szopy, hej pasterze,  [D] [A]
...
`,BA=`1. Ktoś zbudował dom na piasku,     [h]
...
`,NA=`Dotknij Panie moich oczu, [D] [A]
abym przejrzał [h]
...
`,MA=`Duchu Miłości wylewaj się na nas [D] [A] [h] [fis]
Z przebitego serca Jezusa, Jezusa. [G] [D/Fis] [e7] [A7]
`,PA=`Ref. Duchu Święty, błagam nie zwlekaj! [D] [D7+] [G] [A]
...
Ref. Duchu Święty…
`,HA=`Ref. Duchu Święty, Boże przyjdź,    [g] [d]
...
`,JA=`1. Duchu Święty, obiecany nam [e] [C] [D] [h] [a] [h] [e]
...
`,FA=`Duchu Święty ogarnij mnie           [C] [G] [E] [a]
...
`,UA=`Duchu Święty, pouczaj mnie. [e] [h]
Duchu Święty, poprowadź mnie. [e] [h]
Chcę iść za Tobą Duchu Święty, [C] [D] [e]
chcę iść za Tobą Duchu Święty. [C] [D] [e]
`,KA=`/x2/ Duchu Święty, Duchu Święty [a] [F7+] [d] [E7]
...
`,ZA=`Duchu Święty, Tchnienie Ojca,   [F] [B]
Dawco życia.                    [F]
...
`,WA=`1. Duszo Chrystusowa, uświęć mnie.      [d] [a] [d]
...
Na wieki wieków. Amen.                  [d] [C] [a] [C] [d]`,YA=`Ref. Duszo ma, Pana chwal,  [G] [D]
...
`,IA=`1. Dzisiaj w Betlejem, dzisiaj w Betlejem wesoła nowina [D] [A]
...
`,$A=`1. Wielkie światło, które dałeś [D]
...
Fundamentem jest miłość. [e] [C]
 [cis7/5-] [C7+] [e7/9]
`,nC=`1. Gdy się Chrystus rodzi, [C] [F] [C]
...
`,aC=`Ref. Gloria in excelsis Deo, Gloria, Gloria! [A] [cis] [D] [E] [E7]
...
`,oC=`1. Godzien chwały jest Baranek [C] [g]
...
`,lC=`1. Golgoto, Golgoto, Golgoto! [g] [c] [F] [B] [D7]
...
Ref. To nie gwoździe Cię przybiły…
`,cC=`1. Gore gwiazda Jezusowi        [d] [F]
...
`,rC=`1. Hosanna, hosanna, hosanna na niebiosach. [D] [A] [h] [G] [A]
...
`,uC=`O Stworzycielu, Duchu, przyjdź,
...
Ref. Oto ja - służebnica Pańska...
`,dC=`Ref. Idzie mój Pan, idzie mój Pan [d]
...
`,zC=`1. Panie, dla Ciebie nie ma rzeczy [E7+]
niemożliwych. [A]
...
`,yC=`1. Ja wierzę, że to Jezus [E] [A] [H7]
...
`,wC=`1. Tyle światła wokół mnie, [Es-sus2]
...
Ref. Jahwe – Ty jesteś światłem…
`,hC=`Jak dobrze jest dziękować Ci Panie [a7] [d7]
...
`,gC=`Ref. Jak w Betlejem cud zdarzył się     [d] [C]
...
Twe Imię Jezu x2                  [G] [F]
`,bC=`Jedyny Pan, prawdziwy Bóg, [a] [D] [G] [C]
...
Solo gitara [A7] [D7] [G] [C] [|x3]
 [F] [G] [|x2]
`,jC=`Jego Miłość zakrywa grzech [e] [h]
...
`,_C=`1. Jestem dzieckiem Boga, [a7] [e7]
...
`,AC=`Jestem tego pewien, nic nie oddzieli nas    [a7/9]
...
`,CC=`1. Ty światłość dnia wszedłeś [E] [H]
...
`,DC=`Jesteś Królem, jesteś Królem [E] [H7] [cis]
...
`,TC=`Ref. Jesteś perłą w życiu mym [E]
...
Ty otwierasz nasze oczy, Panie, [g7] [d7] [C]
na Twoje piękno! [F]
`,SC=`Jezu jesteś tu                  [A] [E/Gis] [fis] [fis/E]
...
`,xC=`Jezu, Tyś wszystkim dla mnie jest, [D] [Asus4] [G] [A]
...
Otworzyło się, obmywając z grzechów mnie.
 [d] [C] [B7+] [C] [(Dadd9)]
`,OC=`1. Jezus daje nam zbawienie     [d] [C] [a] [d]
...
Daj mi dłoń [C] [e/H] [a7] [Gsus4]
 [F] [As] [G] [C7+]
`,NC=`/x3/ Jezus jest z nami tu [B] [C] [F] [d]
...
`,PC=`Jezus, najwyższe Imię [D] [D7+] [D6] [D7+]
...
`,HC=`Jezus, Jezus, Jezus, Jezus, Jezus [D] [E7] [G] [A7] [D]

Ref. Pokonał śmierć, pokonał mój grzech [G] [D]
Zmartwychwstał Pan i Królem jest [G] [D]
 [G] [D] [G] [A] [D]
`,JC=`Ref. Jezus uzdrawia dziś. Alleluja! [e] [G] [a] [H7]
...
`,FC=`1. Jezusa narodzonego wszyscy witajmy, [D] [G] [D] [A] [A7] [D]
...
`,UC=`Już teraz we mnie kwitną Twe ogrody, [C] [F] [G]
już teraz we mnie Twe królestwo jest. x2 [F] [d] [G] [(C)]
`,KC=`1. My, którzy wszystko liczymy, [h]
...
Ref: Kiedyś wino i chleb…
`,ZC=`1. Kocham Twoją wolę Panie, [h] [Fis]
...
`,WC=`1. Kocham, więc nie muszę się bać [H]
...
Ref. Takie jest prawo miłości…
`,qC=`Ojcze nasz, Zdrowaś Maryjo, Wierzę w Boga
...
`,XC=`1. Krzyżu Święty, co świat obejmujesz, [d] [A7] [d]
...
Zmiłuj się nad nami.
`,VC=`Łaską jesteśmy zbawieni [A] [fis]
...
`,QC=`Ref.: Lud Twój, Panie, lud pielgrzymi [D] [A] [h] [D7]
...
Ref. Lud Twój, Panie…
`,IC=`1. Lulajże Jezuniu, moja perełko, [C] [d] [G] [C]
...
`,$C=`Maryjo, chcę zamieszkać z Tobą,     [F] [C]
...
`,eD=`1. Maryjo, Matko mojego wezwania [G] [H]
...
Bądź! [fis] [A2] [H4] [E]
`,iD=`Maryjo, wzorze prostoty, [E] [fis7/11] [cis7/9]
...
`,aD=`1. Mędrcy świata Monarchowie,     [A] [D] [A]
...
`,tD=`Ref. Alleluja, alleluja,            [B] [C] [a] [B]
Alleluja amen                       [g] [a] [G]
...
Ref. Śpiewam… Dlatego śpiewam
`,cD=`1. Mizerna, cicha, stajenka licha, [a] [h7/5-] [a] [E7]
...
`,rD=`1. Zabierz, Panie, i przyjmij [a] [G]
...
`,uD=`Przymnóż nam wiary, Panie       [fis] [E/Gis] [fis/A] [hsus2]
...
`,dD=`1.Twoje ręce to mój ląd, wiem nie utonę [a] [F] [C]
...
`,zD=`1. Moje wędrowanie, moje upadanie, [D] [E] [A] [D] [E] [fis]
...
`,wD=`(Solo gitara x2)                    [fis] [E] [cis] [D7+]
                                    [h] [cis] [E] [fis] [(E)]
...
Wiele możesz zdziałać.              [h] [cis] [D7+]
                                    [fis] [E] [fis]
`,hD=`1. Mroźna cisza świat okryła [h] [e]
...
Luli, la-a-aj…
`,gD=`Ref. Nadzieja nosi niebieską sukienkę, [D] [G7+] [h]
...
`,bD=`1. Wodę zamieniłeś w wino [cis] [A] [E]
...
`,CD=`Nie bójcie się żyć dla miłości [e] [C] [a] [D]
Dla tej miłości warto żyć [e] [D] [e] [D]
`,DD=`Nie chcę w innym miejscu być [D]
...
`,TD=`Nie lękajcie się, Ja jestem z wami.         [C] [F] [G] [C] [F] [G]
...
`,ED=`Ref. Nie mądrość świata tego,
...
`,SD=`Ref.: Nie, nie, nie lękaj się [A] [D] [E]
...
W Tobie nadzieja ma.
`,ND=`1. Niech wam błogosławi Pan [H] [E] [H] [E]
...
Niech wam błogosławi Pan [a] [G] [C] [F]
 [a] [G] [C] [F]
 [a] [G] [F]
`,RD=`Ref. x2 Alleluja, Alleluja,     [fis] [E]
...
`,MD=`Niechaj zstąpi Duch Twój i odnowi ziemię [e]
...
`,PD=`Ref. Niegodny jestem Panie [d]
...
`,JD=`1. Otwarta na Boga, odwiecznie wybrana  [e]
...
`,FD=`O Jezu, cichy i pokorny         [d] [a] [d] [C]
Uczyń serce me                  [F] [a]
...
`,WD=`O Zbawcza Hostio godna czci,
...
`,YD=`1. Znad oceanów do mnie wołasz [h] [A/Cis] [D]
...
Dla duszy pokój w Tobie jest [G] [D] [A]
Gdzie pójdziesz Ty, ja pójdę też [G] [A]
`,qD=`Ref. Oddaję Ci życie swe [D] [e]
...
Ref. Daj Ducha świętego mi…
`,XD=`Oddajmy cześć wiecznemu Panu chwał, [h] [e] [fis] [h]
...
`,ID=`Ojcze nasz, który jesteś w niebie [B] [F] [g7] [d]
...
Z głębi serca dziś wołam: Maranatha /x2 [A] [H7] [cis]
 [A] [H7] [E]
`,e2=`Ref. Oto ja, poślij mnie. [E] [A] [H7]
...
Ref. Oto ja, poślij mnie…
`,n2=`Ref. Oto są baranki młode, oto ci, co zawołali: alleluja!
...
Ref. Oto są baranki młode…
`,i2=`1. Usłyszałem i ujrzałem [A] [A4/3]
...
`,s2=`Pan jest mocą Swojego ludu          [F] [B] [C7]
...
`,l2=`Pan jest Pasterzem moim, [h] [e] [G] [A] [h]
...
pocieszają. [h]
`,c2=`Pan mnie strzeże, Pan mnie strzeże. Czuwa [E] [A]
...
`,u2=`Panie mój, przychodzę dziś,     [D] [G]
...
`,f2=`Panie, Twój tron wznosi się [e] [A]
...
`,y2=`1. Pastuszkowie bracia mili [F]
...
`,w2=`1. Pełen czci przed Tobą klękam    [G] [D]
...
`,h2=`1. Po szabacie pierwszego dnia z rana [e] [C]
...
`,g2=`Podnieś mnie, Jezu i prowadź do Ojca [d] [C] [a]
...
I obfite odkupienie.`,j2=`2x: Pokorna Służebnico Pana [g] [F]
...
`,k2=`Powietrzem moim Jest x2 [F] [B] [F] [B]
...
`,_2=`1. Powstań i świeć oto tutaj twe światło, [d] [A]
...
`,C2=`1. Prawda jedyna słowa Jezusa z Nazaretu, [D] [A] [fis] [cis]
...
`,D2=`Przed Tobą, Wszechmocny,    [B] [F/A]
...
`,T2=`1. Przybądź Duchu Święty, ześlij z nieba wzięty [d] [C] [B]
...
daj szczęście bez miary! [C] [F] [B] [C]
`,E2=`1. Języku ognia przyjdź [H2] [D2]
...
4. Dziwili się napowietrznej muzyce
i myśleli, co to będzie za Dziecię?
`,G2=`Przyjaciela mam, co pociesza mnie, [C] [G] [a] [F]
...
Jezus, Jezus
`,O2=`Przyjacielu, przyjacielu    [G] [e]
...
`,B2=`1. Przyjdź jak deszcz ożyw dziś [cis] [A]
...
`,N2=`1. Przyjdź, królestwo Twoje [D] [A] [h]
...
`,H2=`Ref.: Śpiewajcie Panu, bo wielka Jego moc i chwała!
...
`,J2=`Raduje się dusza ma, wielbi Pana swego [fis]
...
Pan mój Zbawca [Cis]
`,F2=`Ref. Rozpięty na ramionach [a] [C] [G]
...
Ref.: Rozpięty…
`,U2=`Rzekł Pan, stało się: Jam Alfa i Omega [D] [Asus4] [A] [e7]
...
`,Z2=`1. Skrzypi wóz, wielki mróz,  [F] [B]
...
`,W2=`1. Światłość świata rozjaśnia mrok      [c] [As] [B] [f]
...
`,Y2=`1. Śpiewaj Panu, swemu Bogu [D]
...
`,X2=`Spocznij na nas, Duchu Pana, [D] [A] [G] [e7]
...
Ref. Znalazłem Cię…
`,eT=`Ref. x2 Szukam Cię, Panie, [cis] [gis]
o wschodzie [A] [H]
...
Taki jesteś Ty...
`,aT=`Ref. To jest Baranka Ciało, Jego Krew [fis] [cis]
...
`,lT=`Ty masz moc uzdrowienia, Jezu. [A] [G/A]
...
`,cT=`1. Gdy drogi pomyli los zły [G] [C7+]
...
(Solo skrzypce)         [D] [A] [h]
                        ...
                        [G] [D] [G] [A7]
                        [D]
`,uT=`Ukaż mi, Panie, Swą twarz. [D] [G] [D] [G]
...
`,fT=`1. Tylko w Bogu moje jest zbawienie. [D7+] [E] [fis4-3]
...
Tylko w Bogu moje jest zbawienie.      [E7+] [Fis] [gis]
                                       [E7+] [Fis] [Gis]
`,dT=`1. Upadnij na kolana,           [e] [H] [e] [H7]
...
`,bT=`W Swym Sercu na wieki ukryłeś nas, [e] [A] [G] [A]
...
Ref. Jezu, Serce Twoje….
`,jT=`Ref. Aaa, alleluja, w Tobie cała nadzieja ma [f] [b] [C]
...
`,vT=`W Tobie jest światło, każdy mrok rozjaśni. [h] [A] [G] [D] [fis7]
...
`,_T=`1. W żłobie leży, któż pobieży          [D] [A]
...
`,AT=`1. W żłobie leży, któż pobieży          [D] [e] [A7]
...
Pod nieba Empirejskie.
                                        [Fis7] [G] [g6] [A7] [D]
`,CT=`Więcej miłości, więcej mocy [e] [C]
...
potężniejsza jest.      [G] [A] [D]
 ...
 ---
`,ET=`1. Wspaniały Dawco miłości, [D] [G] [D] [G]
...
`,ST=`1. Wśród nocnej ciszy           [D] [A] [D] [A7]
...
`,xT=`Wszyscy ludzie klaszczą w dłonie [C] [G] [D] [e7]
...
Wszyscy ludzie… Nadejdzie dzień…
`,GT=`Wszystkie narody klaskajcie w dłonie [D]
...
`,OT=`Ref. Wszystko, co dziś mamy [A] [cis]
...
jest Królem całej ziemi.       [d]
Bóg Abrahama                   [d]
`,NT=`Ref. Wykrzykujcie na cześć Pana [e] [C]
...
`,RT=`Ref. Wypłyń na głębię /x2 [G] [A] [D] [h]
...
`,MT=`Ref. Yeshua, Yeshua [g] [d] [Es] [F] [g]
...
`,PT=`Ty, który jesteś samą Prawdą, [Es] [F] [g]
...
W chwale Ojca [G]
`,HT=`1. Z Narodzenia Pana dzień dziś wesoły. [D] [G] [A] [D]
...
`,JT=`1. 2x Z okrzykiem radości [G] [D]
...
`,FT=`Z Tobą ciemność nie będzie ciemna [E] [a] [G] [C]
Wokół mnie [F] [E]
A noc tak jak dzień zajaśnieje [a] [G] [C] [d] [E]
`,UT=`1. Za to, że mnie ukochałeś [D] [h]
...
`,KT=`Ref. Zaśpiewajcie Panu pieśń nową [D] [E] [fis]
...
Ref.2x Jeżeli chcesz Mnie naśladować...
`,WT=`1. Zbliżam się w pokorze i niskości swej. [C] [G] [a]
...
`,YT=`Ref. Zbudowani na Chrystusie [C] [G]
...
`,XT=`Ref. Zmartwychwstał Pan i żyje dziś, [e] [C] [G]
...
`,VT=`1. Zwykły chleb przemieniasz, Panie, [E]
w Ciało Swe, [A] [E] [(A] [E)]
...
Bóg wywiedzie życie
Jak wtedy o świcie
`,IT=`1. Ten którego pocałuję w twarz, [d] [C]
