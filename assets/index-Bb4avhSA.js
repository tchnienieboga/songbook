...
If it declares any Font Awesome CSS pseudo-elements, they will not be rendered as SVG icons. Add crossorigin="anonymous" to the <link>, enable searchPseudoElementsFullScan for slower but more thorough DOM parsing, or suppress this warning by setting searchPseudoElementsWarnings to false.`))}}}catch(U){u.e(U)}finally{u.f()}if(!c.size)return;var L=Array.from(c).join(", ");try{s=o.querySelectorAll(L)}catch{}}return new Promise(function(U,ee){var q=Bt(s).filter(Y0).map(W0),W=of.begin("searchPseudoElements");Bh(),Promise.all(q).then(function(){W(),Ru(),U()}).catch(function(){W(),Ru(),ee()})})}}var V0={hooks:function(){return{mutationObserverCallbacks:function(s){return s.pseudoElementsCallback=Qy,s}}},provides:function(t){t.pseudoElements2svg=function(s){var c=s.node,u=c===void 0?Be:c;V.searchPseudoElements&&Qy(u)}}},Iy=!1,Q0={mixout:function(){return{dom:{unwatch:function(){Bh(),Iy=!0}}}},hooks:function(){return{bootstrap:function(){Zy(xu("mutationObserverCallbacks",{}))},noAuto:function(){T0()},watch:function(s){var c=s.observeMutationsRoot;Iy?Ru():Zy(xu("mutationObserverCallbacks",{observeMutationsRoot:c}))}}}},$y=function(t){var s={size:16,x:0,y:0,flipX:!1,flipY:!1,rotate:0};return t.toLowerCase().split(" ").reduce(function(c,u){var d=u.toLowerCase().split("-"),z=d[0],y=d.slice(1).join("-");if(z&&y==="h")return c.flipX=!0,c;if(z&&y==="v")return c.flipY=!0,c;if(y=parseFloat(y),isNaN(y))return c;switch(z){case"grow":c.size=c.size+y;break;case"shrink":c.size=c.size-y;break;case"left":c.x=c.x-y;break;case"right":c.x=c.x+y;break;case"up":c.y=c.y-y;break;case"down":c.y=c.y+y;break;case"rotate":c.rotate=c.rotate+y;break}return c},s)},I0={mixout:function(){return{parse:{transform:function(s){return $y(s)}}}},hooks:function(){return{parseNodeAttributes:function(s,c){var u=c.getAttribute("data-fa-transform");return u&&(s.transform=$y(u)),s}}},provides:function(t){t.generateAbstractTransformGrouping=function(s){var c=s.main,u=s.transform,d=s.containerWidth,z=s.iconWidth,y={transform:"translate(".concat(d/2," 256)")},h="translate(".concat(u.x*32,", ").concat(u.y*32,") "),w="scale(".concat(u.size/16*(u.flipX?-1:1),", ").concat(u.size/16*(u.flipY?-1:1),") "),v="rotate(".concat(u.rotate," 0 0)"),k={transform:"".concat(h," ").concat(w," ").concat(v)},G={transform:"translate(".concat(z/2*-1," -256)")},M={outer:y,inner:k,path:G};return{tag:"g",attributes:R({},M.outer),children:[{tag:"g",attributes:R({},M.inner),children:[{tag:c.icon.tag,children:c.icon.children,attributes:R(R({},c.icon.attributes),M.path)}]}]}}}},du={x:0,y:0,width:"100%",height:"100%"};function ew(o){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0;return o.attributes&&(o.attributes.fill||t)&&(o.attributes.fill="black"),o}function $0(o){return o.tag==="g"?o.children:[o]}var e_={hooks:function(){return{parseNodeAttributes:function(s,c){var u=c.getAttribute("data-fa-mask"),d=u?El(u.split(" ").map(function(z){return z.trim()})):Eh();return d.prefix||(d.prefix=aa()),s.mask=d,s.maskId=c.getAttribute("data-fa-mask-id"),s}}},provides:function(t){t.generateAbstractMask=function(s){var c=s.children,u=s.attributes,d=s.main,z=s.mask,y=s.maskId,h=s.transform,w=d.width,v=d.icon,k=z.width,G=z.icon,M=Zk({transform:h,containerWidth:k,iconWidth:w}),L={tag:"rect",attributes:R(R({},du),{},{fill:"white"})},U=v.children?{children:v.children.map(ew)}:{},ee={tag:"g",attributes:R({},M.inner),children:[ew(R({tag:v.tag,attributes:R(R({},v.attributes),M.path)},U))]},q={tag:"g",attributes:R({},M.outer),children:[ee]},W="mask-".concat(y||By()),I="clip-".concat(y||By()),ue={tag:"mask",attributes:R(R({},du),{},{id:W,maskUnits:"userSpaceOnUse",maskContentUnits:"userSpaceOnUse"}),children:[L,q]},Y={tag:"defs",children:[{tag:"clipPath",attributes:{id:I},children:$0(G)},ue]};return c.push(Y,{tag:"rect",attributes:R({fill:"currentColor","clip-path":"url(#".concat(I,")"),mask:"url(#".concat(W,")")},du)}),{children:c,attributes:u}}}},n_={provides:function(t){var s=!1;ia.matchMedia&&(s=ia.matchMedia("(prefers-reduced-motion: reduce)").matches),t.missingIconAbstract=function(){var c=[],u={fill:"currentColor"},d={attributeType:"XML",repeatCount:"indefinite",dur:"2s"};c.push({tag:"path",attributes:R(R({},u),{},{d:"M156.5,447.7l-12.6,29.5c-18.7-9.5-35.9-21.2-51.5-34.9l22.7-22.7C127.6,430.5,141.5,440,156.5,447.7z M40.6,272H8.5 c1.4,21.2,5.4,41.7,11.7,61.1L50,321.2C45.1,305.5,41.8,289,40.6,272z M40.6,240c1.4-18.8,5.2-37,11.1-54.1l-29.5-12.6 C14.7,194.3,10,216.7,8.5,240H40.6z M64.3,156.5c7.8-14.9,17.2-28.8,28.1-41.5L69.7,92.3c-13.7,15.6-25.5,32.8-34.9,51.5 L64.3,156.5z M397,419.6c-13.9,12-29.4,22.3-46.1,30.4l11.9,29.8c20.7-9.9,39.8-22.6,56.9-37.6L397,419.6z M115,92.4 c13.9-12,29.4-22.3,46.1-30.4l-11.9-29.8c-20.7,9.9-39.8,22.6-56.8,37.6L115,92.4z M447.7,355.5c-7.8,14.9-17.2,28.8-28.1,41.5 l22.7,22.7c13.7-15.6,25.5-32.9,34.9-51.5L447.7,355.5z M471.4,272c-1.4,18.8-5.2,37-11.1,54.1l29.5,12.6 c7.5-21.1,12.2-43.5,13.6-66.8H471.4z M321.2,462c-15.7,5-32.2,8.2-49.2,9.4v32.1c21.2-1.4,41.7-5.4,61.1-11.7L321.2,462z M240,471.4c-18.8-1.4-37-5.2-54.1-11.1l-12.6,29.5c21.1,7.5,43.5,12.2,66.8,13.6V471.4z M462,190.8c5,15.7,8.2,32.2,9.4,49.2h32.1 c-1.4-21.2-5.4-41.7-11.7-61.1L462,190.8z M92.4,397c-12-13.9-22.3-29.4-30.4-46.1l-29.8,11.9c9.9,20.7,22.6,39.8,37.6,56.9 L92.4,397z M272,40.6c18.8,1.4,36.9,5.2,54.1,11.1l12.6-29.5C317.7,14.7,295.3,10,272,8.5V40.6z M190.8,50 c15.7-5,32.2-8.2,49.2-9.4V8.5c-21.2,1.4-41.7,5.4-61.1,11.7L190.8,50z M442.3,92.3L419.6,115c12,13.9,22.3,29.4,30.5,46.1 l29.8-11.9C470,128.5,457.3,109.4,442.3,92.3z M397,92.4l22.7-22.7c-15.6-13.7-32.8-25.5-51.5-34.9l-12.6,29.5 C370.4,72.1,384.4,81.5,397,92.4z"})});var z=R(R({},d),{},{attributeName:"opacity"}),y={tag:"circle",attributes:R(R({},u),{},{cx:"256",cy:"364",r:"28"}),children:[]};return s||y.children.push({tag:"animate",attributes:R(R({},d),{},{attributeName:"r",values:"28;14;28;28;14;28;"})},{tag:"animate",attributes:R(R({},z),{},{values:"1;0;1;1;0;1;"})}),c.push(y),c.push({tag:"path",attributes:R(R({},u),{},{opacity:"1",d:"M263.7,312h-16c-6.6,0-12-5.4-12-12c0-71,77.4-63.9,77.4-107.8c0-20-17.8-40.2-57.4-40.2c-29.1,0-44.3,9.6-59.2,28.7 c-3.9,5-11.1,6-16.2,2.4l-13.1-9.2c-5.6-3.9-6.9-11.8-2.6-17.2c21.2-27.2,46.4-44.7,91.2-44.7c52.3,0,97.4,29.8,97.4,80.2 c0,67.6-77.4,63.5-77.4,107.8C275.7,306.6,270.3,312,263.7,312z"}),children:s?[]:[{tag:"animate",attributes:R(R({},z),{},{values:"1;0;0;0;0;1;"})}]}),s||c.push({tag:"path",attributes:R(R({},u),{},{opacity:"0",d:"M232.5,134.5l7,168c0.3,6.4,5.6,11.5,12,11.5h9c6.4,0,11.7-5.1,12-11.5l7-168c0.3-6.8-5.2-12.5-12-12.5h-23 C237.7,122,232.2,127.7,232.5,134.5z"}),children:[{tag:"animate",attributes:R(R({},z),{},{values:"0;0;1;1;0;0;"})}]}),{tag:"g",attributes:{class:"missing"},children:c}}}},i_={hooks:function(){return{parseNodeAttributes:function(s,c){var u=c.getAttribute("data-fa-symbol"),d=u===null?!1:u===""?!0:u;return s.symbol=d,s}}}},a_=[qk,P0,H0,J0,F0,V0,Q0,I0,e_,n_,i_];u0(a_,{mixoutsTo:Sn});Sn.noAuto;var Ho=Sn.config;Sn.library;Sn.dom;var Mh=Sn.parse;Sn.findIconDefinition;Sn.toHtml;var t_=Sn.icon;Sn.layer;Sn.text;Sn.counter;function o_(o){return o=o-0,o===o}function Ph(o){return o_(o)?o:(o=o.replace(/[_-]+(.)?/g,(t,s)=>s?s.toUpperCase():""),o.charAt(0).toLowerCase()+o.slice(1))}function s_(o){return o.charAt(0).toUpperCase()+o.slice(1)}var _t=new Map,l_=1e3;function c_(o){if(_t.has(o))return _t.get(o);const t={};let s=0;const c=o.length;for(;s<c;){const u=o.indexOf(";",s),d=u===-1?c:u,z=o.slice(s,d).trim();if(z){const y=z.indexOf(":");if(y>0){const h=z.slice(0,y).trim(),w=z.slice(y+1).trim();if(h&&w){const v=Ph(h);t[v.startsWith("webkit")?s_(v):v]=w}}}s=d+1}if(_t.size===l_){const u=_t.keys().next().value;u&&_t.delete(u)}return _t.set(o,t),t}function Hh(o,t,s={}){if(typeof t=="string")return t;const c=(t.children||[]).map(v=>Hh(o,v)),u=t.attributes||{},d={};for(const[v,k]of Object.entries(u))switch(!0){case v==="class":{d.className=k;break}case v==="style":{d.style=c_(String(k));break}case v.startsWith("aria-"):case v.startsWith("data-"):{d[v.toLowerCase()]=k;break}default:d[Ph(v)]=k}const{style:z,role:y,"aria-label":h,...w}=s;return z&&(d.style=d.style?{...d.style,...z}:z),y&&(d.role=y),h&&(d["aria-label"]=h,d["aria-hidden"]="false"),o(t.tag,{...w,...d},...c)}var r_=Hh.bind(null,Ln.createElement),nw=(o,t)=>{const s=B.useId();return o||(t?s:void 0)},u_=class{constructor(o="react-fontawesome"){this.enabled=!1;let t=!1;try{t=typeof process<"u"&&!1}catch{}this.scope=o,this.enabled=t}log(...o){this.enabled&&console.log(`[${this.scope}]`,...o)}warn(...o){this.enabled&&console.warn(`[${this.scope}]`,...o)}error(...o){this.enabled&&console.error(`[${this.scope}]`,...o)}},f_="searchPseudoElementsFullScan"in Ho?"7.0.0":"6.0.0",d_=Number.parseInt(f_)>=7,Mo="fa",ji={beat:"fa-beat",fade:"fa-fade",beatFade:"fa-beat-fade",bounce:"fa-bounce",shake:"fa-shake",spin:"fa-spin",spinPulse:"fa-spin-pulse",spinReverse:"fa-spin-reverse",pulse:"fa-pulse"},m_={left:"fa-pull-left",right:"fa-pull-right"},z_={90:"fa-rotate-90",180:"fa-rotate-180",270:"fa-rotate-270"},y_={"2xs":"fa-2xs",xs:"fa-xs",sm:"fa-sm",lg:"fa-lg",xl:"fa-xl","2xl":"fa-2xl","1x":"fa-1x","2x":"fa-2x","3x":"fa-3x","4x":"fa-4x","5x":"fa-5x","6x":"fa-6x","7x":"fa-7x","8x":"fa-8x","9x":"fa-9x","10x":"fa-10x"},vi={border:"fa-border",fixedWidth:"fa-fw",flip:"fa-flip",flipHorizontal:"fa-flip-horizontal",flipVertical:"fa-flip-vertical",inverse:"fa-inverse",rotateBy:"fa-rotate-by",swapOpacity:"fa-swap-opacity",widthAuto:"fa-width-auto"};function w_(o){const t=Ho.cssPrefix||Ho.familyPrefix||Mo;return t===Mo?o:o.replace(new RegExp(String.raw`(?<=^|\s)${Mo}-`,"g"),`${t}-`)}function h_(o){const{beat:t,fade:s,beatFade:c,bounce:u,shake:d,spin:z,spinPulse:y,spinReverse:h,pulse:w,fixedWidth:v,inverse:k,border:G,flip:M,size:L,rotation:U,pull:ee,swapOpacity:q,rotateBy:W,widthAuto:I,className:ue}=o,Y=[];return ue&&Y.push(...ue.split(" ")),t&&Y.push(ji.beat),s&&Y.push(ji.fade),c&&Y.push(ji.beatFade),u&&Y.push(ji.bounce),d&&Y.push(ji.shake),z&&Y.push(ji.spin),h&&Y.push(ji.spinReverse),y&&Y.push(ji.spinPulse),w&&Y.push(ji.pulse),v&&Y.push(vi.fixedWidth),k&&Y.push(vi.inverse),G&&Y.push(vi.border),M===!0&&Y.push(vi.flip),(M==="horizontal"||M==="both")&&Y.push(vi.flipHorizontal),(M==="vertical"||M==="both")&&Y.push(vi.flipVertical),L!=null&&Y.push(y_[L]),U!=null&&U!==0&&Y.push(z_[U]),ee!=null&&Y.push(m_[ee]),q&&Y.push(vi.swapOpacity),d_?(W&&Y.push(vi.rotateBy),I&&Y.push(vi.widthAuto),(Ho.cssPrefix||Ho.familyPrefix||Mo)===Mo?Y:Y.map(w_)):Y}var p_=o=>typeof o=="object"&&"icon"in o&&!!o.icon;function iw(o){if(o)return p_(o)?o:Mh.icon(o)}function g_(o){return Object.keys(o)}var aw=new u_("FontAwesomeIcon"),Jh={border:!1,className:"",mask:void 0,maskId:void 0,fixedWidth:!1,inverse:!1,flip:!1,icon:void 0,listItem:!1,pull:void 0,pulse:!1,rotation:void 0,rotateBy:!1,size:void 0,spin:!1,spinPulse:!1,spinReverse:!1,beat:!1,fade:!1,beatFade:!1,bounce:!1,shake:!1,symbol:!1,title:"",titleId:void 0,transform:void 0,swapOpacity:!1,widthAuto:!1},b_=new Set(Object.keys(Jh)),ki=Ln.forwardRef((o,t)=>{const s={...Jh,...o},{icon:c,mask:u,symbol:d,title:z,titleId:y,maskId:h,transform:w}=s,v=nw(h,!!u),k=nw(y,!!z),G=iw(c);if(!G)return aw.error("Icon lookup is undefined",c),null;const M=h_(s),L=typeof w=="string"?Mh.transform(w):w,U=iw(u),ee=t_(G,{...M.length>0&&{classes:M},...L&&{transform:L},...U&&{mask:U},symbol:d,title:z,titleId:k,maskId:v});if(!ee)return aw.error("Could not find icon",G),null;const{abstract:q}=ee,W={ref:t};for(const I of g_(s))b_.has(I)||(W[I]=s[I]);return r_(q[0],W)});ki.displayName="FontAwesomeIcon";var j_={prefix:"fas",iconName:"trash",icon:[448,512,[],"f1f8","M136.7 5.9L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-8.7-26.1C306.9-7.2 294.7-16 280.9-16L167.1-16c-13.8 0-26 8.8-30.4 21.9zM416 144L32 144 53.1 467.1C54.7 492.4 75.7 512 101 512L347 512c25.3 0 46.3-19.6 47.9-44.9L416 144z"]},v_={prefix:"fas",iconName:"guitar",icon:[512,512,[],"f7a6","M465 7c-9.4-9.4-24.6-9.4-33.9 0L383 55c-2.4 2.4-4.3 5.3-5.5 8.5l-15.4 41-77.5 77.6c-45.1-29.4-99.3-30.2-131 1.6-11 11-18 24.6-21.4 39.6-3.7 16.6-19.1 30.7-36.1 31.6-25.6 1.3-49.3 10.7-67.3 28.6-44.8 44.8-36.4 125.8 18.7 180.9S183.6 528 228.4 483.2c17.9-17.9 27.4-41.7 28.6-67.3 .9-17 15-32.3 31.6-36.1 15-3.4 28.6-10.5 39.6-21.4 31.8-31.8 31-85.9 1.6-131l77.6-77.6 41-15.4c3.2-1.2 6.1-3.1 8.5-5.5l48-48c9.4-9.4 9.4-24.6 0-33.9L465 7zM208 256a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"]},k_={prefix:"fas",iconName:"xmark",icon:[384,512,[128473,10005,10006,10060,215,"close","multiply","remove","times"],"f00d","M55.1 73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L147.2 256 9.9 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192.5 301.3 329.9 438.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.8 256 375.1 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192.5 210.7 55.1 73.4z"]},__=k_,A_={prefix:"fas",iconName:"star",icon:[576,512,[11088,61446],"f005","M309.5-18.9c-4.1-8-12.4-13.1-21.4-13.1s-17.3 5.1-21.4 13.1L193.1 125.3 33.2 150.7c-8.9 1.4-16.3 7.7-19.1 16.3s-.5 18 5.8 24.4l114.4 114.5-25.2 159.9c-1.4 8.9 2.3 17.9 9.6 23.2s16.9 6.1 25 2L288.1 417.6 432.4 491c8 4.1 17.7 3.3 25-2s11-14.2 9.6-23.2L441.7 305.9 556.1 191.4c6.4-6.4 8.6-15.8 5.8-24.4s-10.1-14.9-19.1-16.3L383 125.3 309.5-18.9z"]},C_={prefix:"fas",iconName:"caret-up",icon:[320,512,[],"f0d8","M140.3 135.2c12.6-10.3 31.1-9.5 42.8 2.2l128 128c9.2 9.2 11.9 22.9 6.9 34.9S301.4 320 288.5 320l-256 0c-12.9 0-24.6-7.8-29.6-19.8S.7 274.5 9.9 265.4l128-128 2.4-2.2z"]},D_={prefix:"fas",iconName:"caret-down",icon:[320,512,[],"f0d7","M140.3 376.8c12.6 10.2 31.1 9.5 42.8-2.2l128-128c9.2-9.2 11.9-22.9 6.9-34.9S301.4 192 288.5 192l-256 0c-12.9 0-24.6 7.8-29.6 19.8S.7 237.5 9.9 246.6l128 128 2.4 2.2z"]},Fh={prefix:"fas",iconName:"list-ul",icon:[512,512,["list-dots"],"f0ca","M48 144a48 48 0 1 0 0-96 48 48 0 1 0 0 96zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L192 64zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zM48 464a48 48 0 1 0 0-96 48 48 0 1 0 0 96zM96 256a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z"]};const Sa={PLAIN:"plain",STARRED:"starred",SELECTED:"selected"},jl=({mode:o})=>N.jsx(ki,{icon:A_,className:en("sb-star",`sb-star-mode-${o}`)}),T_=B.memo(({song:o,chooseSong:t,onlyStarred:s})=>{const c=()=>t(o.number),u=s?o.selected?Sa.SELECTED:Sa.STARRED:o.starred?Sa.STARRED:Sa.PLAIN,d=s?o.toggleSelected:o.toggleStarred;return N.jsxs("span",{className:en("sb-menu-songtitle",{"sb-starred-song":o.starred}),children:[N.jsxs("span",{onClick:d,children:[N.jsx(jl,{mode:u})," ",N.jsxs("span",{className:en({"sb-chosen-song":o.chosen}),children:[o.number,". "]})]}),N.jsx("a",{href:"#",onClick:c,className:en("text-reset",{"sb-chosen-song":o.chosen}),children:o.title})]})}),E_=({onlyStarred:o,toggleOnlyStarred:t,starredCount:s,selectedSong:c,searchText:u,setSearchText:d,onClose:z})=>{const y=w=>{d(w.target.value)},h=()=>{t(),d("")};return N.jsxs(N.Fragment,{children:[s?N.jsx("div",{className:"me-2",children:N.jsx(Dt,{variant:"info",onClick:h,children:o?N.jsx(ki,{icon:Fh,role:"button",size:"lg"}):N.jsx(N.Fragment,{children:N.jsxs("span",{className:"sb-no-wrap",children:[N.jsx(jl,{mode:Sa.STARRED})," ",s]})})})}):null,o?c?N.jsxs(N.Fragment,{children:[N.jsx(Dt,{className:"ms-2 me-1",variant:"success",disabled:!c.moveUp,onClick:c.moveUp,children:N.jsx(ki,{icon:C_,role:"button",size:"lg"})}),N.jsx(Dt,{className:"me-3",variant:"success",disabled:!c.moveDown,onClick:c.moveDown,children:N.jsx(ki,{icon:D_,role:"button",size:"lg"})}),N.jsx(Dt,{className:"me-1",variant:"danger",onClick:c.toggleStarred,children:N.jsx(ki,{icon:j_,role:"button",size:"lg"})})]}):N.jsx("div",{className:"ms-2",children:N.jsxs("span",{className:"fw-bold sb-no-wrap",children:["Wybrane ",N.jsx(jl,{mode:Sa.STARRED})," ",s]})}):N.jsx("div",{className:"me-2 flex-grow-1",children:N.jsx("input",{type:"search",className:"form-control",placeholder:"Szukaj",autoCapitalize:"none",autoCorrect:"off",value:u,onChange:y})}),N.jsx("div",{className:"ms-auto",children:N.jsx(Dt,{variant:"light",onClick:z,children:N.jsx(ki,{icon:__,role:"button",size:"lg",onClick:z})})})]})},Uh=o=>o.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[\u0142]/g,"l").replace(/[^a-z ]/g,"").toLowerCase(),S_=({songs:o,checksum:t,chooseSong:s,starredCount:c,onlyStarred:u,toggleOnlyStarred:d,show:z,onClose:y})=>{const[h,w]=B.useState(""),v=B.useRef(null),k=()=>v.current?.scrollIntoView();B.useEffect(()=>{k()},[z,u]);const M=(()=>{const W=h.trim();if(!W)return;const I=parseInt(W,10);return Number.isNaN(I)?Uh(W):I})();B.useEffect(()=>{M||k()},[M]);const L=W=>M?typeof M=="number"?W.number===M:W.latinTitle.includes(M):!0,U=o.findIndex(W=>W.chosen),ee=o.find(W=>W.selected),q=U<3?0:U-3;return N.jsxs(ul,{show:z,onHide:y,scrollable:!0,animation:!1,children:[N.jsx(ul.Header,{className:"py-2 px-2",children:N.jsx(E_,{onlyStarred:u,toggleOnlyStarred:d,starredCount:c,selectedSong:ee,searchText:h,setSearchText:w,onClose:y})}),N.jsx(ul.Body,{children:o.filter(W=>L(W)).map((W,I)=>N.jsxs(B.Fragment,{children:[N.jsx(T_,{song:W,chooseSong:s,onlyStarred:u}),N.jsx("br",{ref:I===q?v:null})]},W.number))}),N.jsx(ul.Footer,{className:"py-0",children:N.jsxs("p",{className:"text-secondary small",children:["Śpiewnik - Tchnienie Boga v","0.4.3"," [",t,"]"]})})]})},x_=({onlyStarred:o,chordsShown:t,onClickMenu:s,onClickGuitar:c})=>N.jsxs("div",{className:"sb-menu-buttons-container",children:[N.jsx("div",{className:en("btn","sb-menu-button","shadow","rounded-circle",t?"sb-menu-button-red":"sb-menu-button-gray","d-flex","justify-content-center","align-items-center","pt-2"),tabIndex:0,role:"button",onClick:c,children:N.jsx("div",{className:"sb-menu-button-icon my-auto",children:N.jsx(ki,{icon:v_,size:"lg"})})}),N.jsx("div",{className:"btn sb-menu-button shadow rounded-circle sb-menu-button-cyan d-flex justify-content-center align-items-center pt-2",tabIndex:1,role:"button",onClick:s,children:N.jsx("div",{className:"sb-menu-button-icon my-auto",children:o?N.jsx(jl,{mode:Sa.STARRED}):N.jsx(ki,{icon:Fh,size:"lg"})})})]}),G_=o=>{const t=localStorage.getItem(o);return typeof t=="string"?JSON.parse(t):void 0},O_=(o,t)=>{t!==void 0&&localStorage.setItem(o,JSON.stringify(t))},Ta=(o,t)=>{const[s,c]=B.useState(()=>{const u=G_(o);return u||t});return B.useEffect(()=>{O_(o,s)},[o,s]),[s,c]};function B_(o,t,s){return Math.max(t,Math.min(o,s))}const Ne={toVector(o,t){return o===void 0&&(o=t),Array.isArray(o)?o:[o,o]},add(o,t){return[o[0]+t[0],o[1]+t[1]]},sub(o,t){return[o[0]-t[0],o[1]-t[1]]},addTo(o,t){o[0]+=t[0],o[1]+=t[1]},subTo(o,t){o[0]-=t[0],o[1]-=t[1]}};function tw(o,t,s){return t===0||Math.abs(t)===1/0?Math.pow(o,s*5):o*t*s/(t+s*o)}function ow(o,t,s,c=.15){return c===0?B_(o,t,s):o<t?-tw(t-o,s-t,c)+t:o>s?+tw(o-s,s-t,c)+s:o}function N_(o,[t,s],[c,u]){const[[d,z],[y,h]]=o;return[ow(t,d,z,c),ow(s,y,h,u)]}function R_(o,t){if(typeof o!="object"||o===null)return o;var s=o[Symbol.toPrimitive];if(s!==void 0){var c=s.call(o,t);if(typeof c!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(o)}function M_(o){var t=R_(o,"string");return typeof t=="symbol"?t:String(t)}function qe(o,t,s){return t=M_(t),t in o?Object.defineProperty(o,t,{value:s,enumerable:!0,configurable:!0,writable:!0}):o[t]=s,o}function sw(o,t){var s=Object.keys(o);if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(o);t&&(c=c.filter(function(u){return Object.getOwnPropertyDescriptor(o,u).enumerable})),s.push.apply(s,c)}return s}function Pe(o){for(var t=1;t<arguments.length;t++){var s=arguments[t]!=null?arguments[t]:{};t%2?sw(Object(s),!0).forEach(function(c){qe(o,c,s[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(s)):sw(Object(s)).forEach(function(c){Object.defineProperty(o,c,Object.getOwnPropertyDescriptor(s,c))})}return o}const Lh={pointer:{start:"down",change:"move",end:"up"},mouse:{start:"down",change:"move",end:"up"},touch:{start:"start",change:"move",end:"end"},gesture:{start:"start",change:"change",end:"end"}};function lw(o){return o?o[0].toUpperCase()+o.slice(1):""}const P_=["enter","leave"];function H_(o=!1,t){return o&&!P_.includes(t)}function J_(o,t="",s=!1){const c=Lh[o],u=c&&c[t]||t;return"on"+lw(o)+lw(u)+(H_(s,u)?"Capture":"")}const F_=["gotpointercapture","lostpointercapture"];function U_(o){let t=o.substring(2).toLowerCase();const s=!!~t.indexOf("passive");s&&(t=t.replace("passive",""));const c=F_.includes(t)?"capturecapture":"capture",u=!!~t.indexOf(c);return u&&(t=t.replace("capture","")),{device:t,capture:u,passive:s}}function L_(o,t=""){const s=Lh[o],c=s&&s[t]||t;return o+c}function xl(o){return"touches"in o}function Kh(o){return xl(o)?"touch":"pointerType"in o?o.pointerType:"mouse"}function K_(o){return Array.from(o.touches).filter(t=>{var s,c;return t.target===o.currentTarget||((s=o.currentTarget)===null||s===void 0||(c=s.contains)===null||c===void 0?void 0:c.call(s,t.target))})}function Z_(o){return o.type==="touchend"||o.type==="touchcancel"?o.changedTouches:o.targetTouches}function Zh(o){return xl(o)?Z_(o)[0]:o}function Pu(o,t){try{const s=t.clientX-o.clientX,c=t.clientY-o.clientY,u=(t.clientX+o.clientX)/2,d=(t.clientY+o.clientY)/2,z=Math.hypot(s,c);return{angle:-(Math.atan2(s,c)*180)/Math.PI,distance:z,origin:[u,d]}}catch{}return null}function W_(o){return K_(o).map(t=>t.identifier)}function cw(o,t){const[s,c]=Array.from(o.touches).filter(u=>t.includes(u.identifier));return Pu(s,c)}function mu(o){const t=Zh(o);return xl(o)?t.identifier:t.pointerId}function Gt(o){const t=Zh(o);return[t.clientX,t.clientY]}const rw=40,uw=800;function Wh(o){let{deltaX:t,deltaY:s,deltaMode:c}=o;return c===1?(t*=rw,s*=rw):c===2&&(t*=uw,s*=uw),[t,s]}function Y_(o){var t,s;const{scrollX:c,scrollY:u,scrollLeft:d,scrollTop:z}=o.currentTarget;return[(t=c??d)!==null&&t!==void 0?t:0,(s=u??z)!==null&&s!==void 0?s:0]}function q_(o){const t={};if("buttons"in o&&(t.buttons=o.buttons),"shiftKey"in o){const{shiftKey:s,altKey:c,metaKey:u,ctrlKey:d}=o;Object.assign(t,{shiftKey:s,altKey:c,metaKey:u,ctrlKey:d})}return t}function vl(o,...t){return typeof o=="function"?o(...t):o}function X_(){}function V_(...o){return o.length===0?X_:o.length===1?o[0]:function(){let t;for(const s of o)t=s.apply(this,arguments)||t;return t}}function fw(o,t){return Object.assign({},t,o||{})}const Q_=32;class Yh{constructor(t,s,c){this.ctrl=t,this.args=s,this.key=c,this.state||(this.state={},this.computeValues([0,0]),this.computeInitial(),this.init&&this.init(),this.reset())}get state(){return this.ctrl.state[this.key]}set state(t){this.ctrl.state[this.key]=t}get shared(){return this.ctrl.state.shared}get eventStore(){return this.ctrl.gestureEventStores[this.key]}get timeoutStore(){return this.ctrl.gestureTimeoutStores[this.key]}get config(){return this.ctrl.config[this.key]}get sharedConfig(){return this.ctrl.config.shared}get handler(){return this.ctrl.handlers[this.key]}reset(){const{state:t,shared:s,ingKey:c,args:u}=this;s[c]=t._active=t.active=t._blocked=t._force=!1,t._step=[!1,!1],t.intentional=!1,t._movement=[0,0],t._distance=[0,0],t._direction=[0,0],t._delta=[0,0],t._bounds=[[-1/0,1/0],[-1/0,1/0]],t.args=u,t.axis=void 0,t.memo=void 0,t.elapsedTime=t.timeDelta=0,t.direction=[0,0],t.distance=[0,0],t.overflow=[0,0],t._movementBound=[!1,!1],t.velocity=[0,0],t.movement=[0,0],t.delta=[0,0],t.timeStamp=0}start(t){const s=this.state,c=this.config;s._active||(this.reset(),this.computeInitial(),s._active=!0,s.target=t.target,s.currentTarget=t.currentTarget,s.lastOffset=c.from?vl(c.from,s):s.offset,s.offset=s.lastOffset,s.startTime=s.timeStamp=t.timeStamp)}computeValues(t){const s=this.state;s._values=t,s.values=this.config.transform(t)}computeInitial(){const t=this.state;t._initial=t._values,t.initial=t.values}compute(t){const{state:s,config:c,shared:u}=this;s.args=this.args;let d=0;if(t&&(s.event=t,c.preventDefault&&t.cancelable&&s.event.preventDefault(),s.type=t.type,u.touches=this.ctrl.pointerIds.size||this.ctrl.touchIds.size,u.locked=!!document.pointerLockElement,Object.assign(u,q_(t)),u.down=u.pressed=u.buttons%2===1||u.touches>0,d=t.timeStamp-s.timeStamp,s.timeStamp=t.timeStamp,s.elapsedTime=s.timeStamp-s.startTime),s._active){const re=s._delta.map(Math.abs);Ne.addTo(s._distance,re)}this.axisIntent&&this.axisIntent(t);const[z,y]=s._movement,[h,w]=c.threshold,{_step:v,values:k}=s;if(c.hasCustomTransform?(v[0]===!1&&(v[0]=Math.abs(z)>=h&&k[0]),v[1]===!1&&(v[1]=Math.abs(y)>=w&&k[1])):(v[0]===!1&&(v[0]=Math.abs(z)>=h&&Math.sign(z)*h),v[1]===!1&&(v[1]=Math.abs(y)>=w&&Math.sign(y)*w)),s.intentional=v[0]!==!1||v[1]!==!1,!s.intentional)return;const G=[0,0];if(c.hasCustomTransform){const[re,Q]=k;G[0]=v[0]!==!1?re-v[0]:0,G[1]=v[1]!==!1?Q-v[1]:0}else G[0]=v[0]!==!1?z-v[0]:0,G[1]=v[1]!==!1?y-v[1]:0;this.restrictToAxis&&!s._blocked&&this.restrictToAxis(G);const M=s.offset,L=s._active&&!s._blocked||s.active;L&&(s.first=s._active&&!s.active,s.last=!s._active&&s.active,s.active=u[this.ingKey]=s._active,t&&(s.first&&("bounds"in c&&(s._bounds=vl(c.bounds,s)),this.setup&&this.setup()),s.movement=G,this.computeOffset()));const[U,ee]=s.offset,[[q,W],[I,ue]]=s._bounds;s.overflow=[U<q?-1:U>W?1:0,ee<I?-1:ee>ue?1:0],s._movementBound[0]=s.overflow[0]?s._movementBound[0]===!1?s._movement[0]:s._movementBound[0]:!1,s._movementBound[1]=s.overflow[1]?s._movementBound[1]===!1?s._movement[1]:s._movementBound[1]:!1;const Y=s._active?c.rubberband||[0,0]:[0,0];if(s.offset=N_(s._bounds,s.offset,Y),s.delta=Ne.sub(s.offset,M),this.computeMovement(),L&&(!s.last||d>Q_)){s.delta=Ne.sub(s.offset,M);const re=s.delta.map(Math.abs);Ne.addTo(s.distance,re),s.direction=s.delta.map(Math.sign),s._direction=s._delta.map(Math.sign),!s.first&&d>0&&(s.velocity=[re[0]/d,re[1]/d],s.timeDelta=d)}}emit(){const t=this.state,s=this.shared,c=this.config;if(t._active||this.clean(),(t._blocked||!t.intentional)&&!t._force&&!c.triggerAllEvents)return;const u=this.handler(Pe(Pe(Pe({},s),t),{},{[this.aliasKey]:t.values}));u!==void 0&&(t.memo=u)}clean(){this.eventStore.clean(),this.timeoutStore.clean()}}function I_([o,t],s){const c=Math.abs(o),u=Math.abs(t);if(c>u&&c>s)return"x";if(u>c&&u>s)return"y"}class Lo extends Yh{constructor(...t){super(...t),qe(this,"aliasKey","xy")}reset(){super.reset(),this.state.axis=void 0}init(){this.state.offset=[0,0],this.state.lastOffset=[0,0]}computeOffset(){this.state.offset=Ne.add(this.state.lastOffset,this.state.movement)}computeMovement(){this.state.movement=Ne.sub(this.state.offset,this.state.lastOffset)}axisIntent(t){const s=this.state,c=this.config;if(!s.axis&&t){const u=typeof c.axisThreshold=="object"?c.axisThreshold[Kh(t)]:c.axisThreshold;s.axis=I_(s._movement,u)}s._blocked=(c.lockDirection||!!c.axis)&&!s.axis||!!c.axis&&c.axis!==s.axis}restrictToAxis(t){if(this.config.axis||this.config.lockDirection)switch(this.state.axis){case"x":t[1]=0;break;case"y":t[0]=0;break}}}const $_=o=>o,dw=.15,qh={enabled(o=!0){return o},eventOptions(o,t,s){return Pe(Pe({},s.shared.eventOptions),o)},preventDefault(o=!1){return o},triggerAllEvents(o=!1){return o},rubberband(o=0){switch(o){case!0:return[dw,dw];case!1:return[0,0];default:return Ne.toVector(o)}},from(o){if(typeof o=="function")return o;if(o!=null)return Ne.toVector(o)},transform(o,t,s){const c=o||s.shared.transform;return this.hasCustomTransform=!!c,c||$_},threshold(o){return Ne.toVector(o,0)}},e1=0,Na=Pe(Pe({},qh),{},{axis(o,t,{axis:s}){if(this.lockDirection=s==="lock",!this.lockDirection)return s},axisThreshold(o=e1){return o},bounds(o={}){if(typeof o=="function")return d=>Na.bounds(o(d));if("current"in o)return()=>o.current;if(typeof HTMLElement=="function"&&o instanceof HTMLElement)return o;const{left:t=-1/0,right:s=1/0,top:c=-1/0,bottom:u=1/0}=o;return[[t,s],[c,u]]}}),mw={ArrowRight:(o,t=1)=>[o*t,0],ArrowLeft:(o,t=1)=>[-1*o*t,0],ArrowUp:(o,t=1)=>[0,-1*o*t],ArrowDown:(o,t=1)=>[0,o*t]};class n1 extends Lo{constructor(...t){super(...t),qe(this,"ingKey","dragging")}reset(){super.reset();const t=this.state;t._pointerId=void 0,t._pointerActive=!1,t._keyboardActive=!1,t._preventScroll=!1,t._delayed=!1,t.swipe=[0,0],t.tap=!1,t.canceled=!1,t.cancel=this.cancel.bind(this)}setup(){const t=this.state;if(t._bounds instanceof HTMLElement){const s=t._bounds.getBoundingClientRect(),c=t.currentTarget.getBoundingClientRect(),u={left:s.left-c.left+t.offset[0],right:s.right-c.right+t.offset[0],top:s.top-c.top+t.offset[1],bottom:s.bottom-c.bottom+t.offset[1]};t._bounds=Na.bounds(u)}}cancel(){const t=this.state;t.canceled||(t.canceled=!0,t._active=!1,setTimeout(()=>{this.compute(),this.emit()},0))}setActive(){this.state._active=this.state._pointerActive||this.state._keyboardActive}clean(){this.pointerClean(),this.state._pointerActive=!1,this.state._keyboardActive=!1,super.clean()}pointerDown(t){const s=this.config,c=this.state;if(t.buttons!=null&&(Array.isArray(s.pointerButtons)?!s.pointerButtons.includes(t.buttons):s.pointerButtons!==-1&&s.pointerButtons!==t.buttons))return;const u=this.ctrl.setEventIds(t);s.pointerCapture&&t.target.setPointerCapture(t.pointerId),!(u&&u.size>1&&c._pointerActive)&&(this.start(t),this.setupPointer(t),c._pointerId=mu(t),c._pointerActive=!0,this.computeValues(Gt(t)),this.computeInitial(),s.preventScrollAxis&&Kh(t)!=="mouse"?(c._active=!1,this.setupScrollPrevention(t)):s.delay>0?(this.setupDelayTrigger(t),s.triggerAllEvents&&(this.compute(t),this.emit())):this.startPointerDrag(t))}startPointerDrag(t){const s=this.state;s._active=!0,s._preventScroll=!0,s._delayed=!1,this.compute(t),this.emit()}pointerMove(t){const s=this.state,c=this.config;if(!s._pointerActive)return;const u=mu(t);if(s._pointerId!==void 0&&u!==s._pointerId)return;const d=Gt(t);if(document.pointerLockElement===t.target?s._delta=[t.movementX,t.movementY]:(s._delta=Ne.sub(d,s._values),this.computeValues(d)),Ne.addTo(s._movement,s._delta),this.compute(t),s._delayed&&s.intentional){this.timeoutStore.remove("dragDelay"),s.active=!1,this.startPointerDrag(t);return}if(c.preventScrollAxis&&!s._preventScroll)if(s.axis)if(s.axis===c.preventScrollAxis||c.preventScrollAxis==="xy"){s._active=!1,this.clean();return}else{this.timeoutStore.remove("startPointerDrag"),this.startPointerDrag(t);return}else return;this.emit()}pointerUp(t){this.ctrl.setEventIds(t);try{this.config.pointerCapture&&t.target.hasPointerCapture(t.pointerId)&&t.target.releasePointerCapture(t.pointerId)}catch{}const s=this.state,c=this.config;if(!s._active||!s._pointerActive)return;const u=mu(t);if(s._pointerId!==void 0&&u!==s._pointerId)return;this.state._pointerActive=!1,this.setActive(),this.compute(t);const[d,z]=s._distance;if(s.tap=d<=c.tapsThreshold&&z<=c.tapsThreshold,s.tap&&c.filterTaps)s._force=!0;else{const[y,h]=s._delta,[w,v]=s._movement,[k,G]=c.swipe.velocity,[M,L]=c.swipe.distance,U=c.swipe.duration;if(s.elapsedTime<U){const ee=Math.abs(y/s.timeDelta),q=Math.abs(h/s.timeDelta);ee>k&&Math.abs(w)>M&&(s.swipe[0]=Math.sign(y)),q>G&&Math.abs(v)>L&&(s.swipe[1]=Math.sign(h))}}this.emit()}pointerClick(t){!this.state.tap&&t.detail>0&&(t.preventDefault(),t.stopPropagation())}setupPointer(t){const s=this.config,c=s.device;s.pointerLock&&t.currentTarget.requestPointerLock(),s.pointerCapture||(this.eventStore.add(this.sharedConfig.window,c,"change",this.pointerMove.bind(this)),this.eventStore.add(this.sharedConfig.window,c,"end",this.pointerUp.bind(this)),this.eventStore.add(this.sharedConfig.window,c,"cancel",this.pointerUp.bind(this)))}pointerClean(){this.config.pointerLock&&document.pointerLockElement===this.state.currentTarget&&document.exitPointerLock()}preventScroll(t){this.state._preventScroll&&t.cancelable&&t.preventDefault()}setupScrollPrevention(t){this.state._preventScroll=!1,i1(t);const s=this.eventStore.add(this.sharedConfig.window,"touch","change",this.preventScroll.bind(this),{passive:!1});this.eventStore.add(this.sharedConfig.window,"touch","end",s),this.eventStore.add(this.sharedConfig.window,"touch","cancel",s),this.timeoutStore.add("startPointerDrag",this.startPointerDrag.bind(this),this.config.preventScrollDelay,t)}setupDelayTrigger(t){this.state._delayed=!0,this.timeoutStore.add("dragDelay",()=>{this.state._step=[0,0],this.startPointerDrag(t)},this.config.delay)}keyDown(t){const s=mw[t.key];if(s){const c=this.state,u=t.shiftKey?10:t.altKey?.1:1;this.start(t),c._delta=s(this.config.keyboardDisplacement,u),c._keyboardActive=!0,Ne.addTo(c._movement,c._delta),this.compute(t),this.emit()}}keyUp(t){t.key in mw&&(this.state._keyboardActive=!1,this.setActive(),this.compute(t),this.emit())}bind(t){const s=this.config.device;t(s,"start",this.pointerDown.bind(this)),this.config.pointerCapture&&(t(s,"change",this.pointerMove.bind(this)),t(s,"end",this.pointerUp.bind(this)),t(s,"cancel",this.pointerUp.bind(this)),t("lostPointerCapture","",this.pointerUp.bind(this))),this.config.keys&&(t("key","down",this.keyDown.bind(this)),t("key","up",this.keyUp.bind(this))),this.config.filterTaps&&t("click","",this.pointerClick.bind(this),{capture:!0,passive:!1})}}function i1(o){"persist"in o&&typeof o.persist=="function"&&o.persist()}const Ko=typeof window<"u"&&window.document&&window.document.createElement;function Xh(){return Ko&&"ontouchstart"in window}function a1(){return Xh()||Ko&&window.navigator.maxTouchPoints>1}function t1(){return Ko&&"onpointerdown"in window}function o1(){return Ko&&"exitPointerLock"in window.document}function s1(){try{return"constructor"in GestureEvent}catch{return!1}}const Un={isBrowser:Ko,gesture:s1(),touch:Xh(),touchscreen:a1(),pointer:t1(),pointerLock:o1()},l1=250,c1=180,r1=.5,u1=50,f1=250,d1=10,zw={mouse:0,touch:0,pen:8},m1=Pe(Pe({},Na),{},{device(o,t,{pointer:{touch:s=!1,lock:c=!1,mouse:u=!1}={}}){return this.pointerLock=c&&Un.pointerLock,Un.touch&&s?"touch":this.pointerLock?"mouse":Un.pointer&&!u?"pointer":Un.touch?"touch":"mouse"},preventScrollAxis(o,t,{preventScroll:s}){if(this.preventScrollDelay=typeof s=="number"?s:s||s===void 0&&o?l1:void 0,!(!Un.touchscreen||s===!1))return o||(s!==void 0?"y":void 0)},pointerCapture(o,t,{pointer:{capture:s=!0,buttons:c=1,keys:u=!0}={}}){return this.pointerButtons=c,this.keys=u,!this.pointerLock&&this.device==="pointer"&&s},threshold(o,t,{filterTaps:s=!1,tapsThreshold:c=3,axis:u=void 0}){const d=Ne.toVector(o,s?c:u?1:0);return this.filterTaps=s,this.tapsThreshold=c,d},swipe({velocity:o=r1,distance:t=u1,duration:s=f1}={}){return{velocity:this.transform(Ne.toVector(o)),distance:this.transform(Ne.toVector(t)),duration:s}},delay(o=0){switch(o){case!0:return c1;case!1:return 0;default:return o}},axisThreshold(o){return o?Pe(Pe({},zw),o):zw},keyboardDisplacement(o=d1){return o}});function Vh(o){const[t,s]=o.overflow,[c,u]=o._delta,[d,z]=o._direction;(t<0&&c>0&&d<0||t>0&&c<0&&d>0)&&(o._movement[0]=o._movementBound[0]),(s<0&&u>0&&z<0||s>0&&u<0&&z>0)&&(o._movement[1]=o._movementBound[1])}const z1=30,y1=100;class w1 extends Yh{constructor(...t){super(...t),qe(this,"ingKey","pinching"),qe(this,"aliasKey","da")}init(){this.state.offset=[1,0],this.state.lastOffset=[1,0],this.state._pointerEvents=new Map}reset(){super.reset();const t=this.state;t._touchIds=[],t.canceled=!1,t.cancel=this.cancel.bind(this),t.turns=0}computeOffset(){const{type:t,movement:s,lastOffset:c}=this.state;t==="wheel"?this.state.offset=Ne.add(s,c):this.state.offset=[(1+s[0])*c[0],s[1]+c[1]]}computeMovement(){const{offset:t,lastOffset:s}=this.state;this.state.movement=[t[0]/s[0],t[1]-s[1]]}axisIntent(){const t=this.state,[s,c]=t._movement;if(!t.axis){const u=Math.abs(s)*z1-Math.abs(c);u<0?t.axis="angle":u>0&&(t.axis="scale")}}restrictToAxis(t){this.config.lockDirection&&(this.state.axis==="scale"?t[1]=0:this.state.axis==="angle"&&(t[0]=0))}cancel(){const t=this.state;t.canceled||setTimeout(()=>{t.canceled=!0,t._active=!1,this.compute(),this.emit()},0)}touchStart(t){this.ctrl.setEventIds(t);const s=this.state,c=this.ctrl.touchIds;if(s._active&&s._touchIds.every(d=>c.has(d))||c.size<2)return;this.start(t),s._touchIds=Array.from(c).slice(0,2);const u=cw(t,s._touchIds);u&&this.pinchStart(t,u)}pointerStart(t){if(t.buttons!=null&&t.buttons%2!==1)return;this.ctrl.setEventIds(t),t.target.setPointerCapture(t.pointerId);const s=this.state,c=s._pointerEvents,u=this.ctrl.pointerIds;if(s._active&&Array.from(c.keys()).every(z=>u.has(z))||(c.size<2&&c.set(t.pointerId,t),s._pointerEvents.size<2))return;this.start(t);const d=Pu(...Array.from(c.values()));d&&this.pinchStart(t,d)}pinchStart(t,s){const c=this.state;c.origin=s.origin,this.computeValues([s.distance,s.angle]),this.computeInitial(),this.compute(t),this.emit()}touchMove(t){if(!this.state._active)return;const s=cw(t,this.state._touchIds);s&&this.pinchMove(t,s)}pointerMove(t){const s=this.state._pointerEvents;if(s.has(t.pointerId)&&s.set(t.pointerId,t),!this.state._active)return;const c=Pu(...Array.from(s.values()));c&&this.pinchMove(t,c)}pinchMove(t,s){const c=this.state,u=c._values[1],d=s.angle-u;let z=0;Math.abs(d)>270&&(z+=Math.sign(d)),this.computeValues([s.distance,s.angle-360*z]),c.origin=s.origin,c.turns=z,c._movement=[c._values[0]/c._initial[0]-1,c._values[1]-c._initial[1]],this.compute(t),this.emit()}touchEnd(t){this.ctrl.setEventIds(t),this.state._active&&this.state._touchIds.some(s=>!this.ctrl.touchIds.has(s))&&(this.state._active=!1,this.compute(t),this.emit())}pointerEnd(t){const s=this.state;this.ctrl.setEventIds(t);try{t.target.releasePointerCapture(t.pointerId)}catch{}s._pointerEvents.has(t.pointerId)&&s._pointerEvents.delete(t.pointerId),s._active&&s._pointerEvents.size<2&&(s._active=!1,this.compute(t),this.emit())}gestureStart(t){t.cancelable&&t.preventDefault();const s=this.state;s._active||(this.start(t),this.computeValues([t.scale,t.rotation]),s.origin=[t.clientX,t.clientY],this.compute(t),this.emit())}gestureMove(t){if(t.cancelable&&t.preventDefault(),!this.state._active)return;const s=this.state;this.computeValues([t.scale,t.rotation]),s.origin=[t.clientX,t.clientY];const c=s._movement;s._movement=[t.scale-1,t.rotation],s._delta=Ne.sub(s._movement,c),this.compute(t),this.emit()}gestureEnd(t){this.state._active&&(this.state._active=!1,this.compute(t),this.emit())}wheel(t){const s=this.config.modifierKey;s&&(Array.isArray(s)?!s.find(c=>t[c]):!t[s])||(this.state._active?this.wheelChange(t):this.wheelStart(t),this.timeoutStore.add("wheelEnd",this.wheelEnd.bind(this)))}wheelStart(t){this.start(t),this.wheelChange(t)}wheelChange(t){"uv"in t||t.cancelable&&t.preventDefault();const c=this.state;c._delta=[-Wh(t)[1]/y1*c.offset[0],0],Ne.addTo(c._movement,c._delta),Vh(c),this.state.origin=[t.clientX,t.clientY],this.compute(t),this.emit()}wheelEnd(){this.state._active&&(this.state._active=!1,this.compute(),this.emit())}bind(t){const s=this.config.device;s&&(t(s,"start",this[s+"Start"].bind(this)),t(s,"change",this[s+"Move"].bind(this)),t(s,"end",this[s+"End"].bind(this)),t(s,"cancel",this[s+"End"].bind(this)),t("lostPointerCapture","",this[s+"End"].bind(this))),this.config.pinchOnWheel&&t("wheel","",this.wheel.bind(this),{passive:!1})}}const h1=Pe(Pe({},qh),{},{device(o,t,{shared:s,pointer:{touch:c=!1}={}}){if(s.target&&!Un.touch&&Un.gesture)return"gesture";if(Un.touch&&c)return"touch";if(Un.touchscreen){if(Un.pointer)return"pointer";if(Un.touch)return"touch"}},bounds(o,t,{scaleBounds:s={},angleBounds:c={}}){const u=z=>{const y=fw(vl(s,z),{min:-1/0,max:1/0});return[y.min,y.max]},d=z=>{const y=fw(vl(c,z),{min:-1/0,max:1/0});return[y.min,y.max]};return typeof s!="function"&&typeof c!="function"?[u(),d()]:z=>[u(z),d(z)]},threshold(o,t,s){return this.lockDirection=s.axis==="lock",Ne.toVector(o,this.lockDirection?[.1,3]:0)},modifierKey(o){return o===void 0?"ctrlKey":o},pinchOnWheel(o=!0){return o}});class p1 extends Lo{constructor(...t){super(...t),qe(this,"ingKey","moving")}move(t){this.config.mouseOnly&&t.pointerType!=="mouse"||(this.state._active?this.moveChange(t):this.moveStart(t),this.timeoutStore.add("moveEnd",this.moveEnd.bind(this)))}moveStart(t){this.start(t),this.computeValues(Gt(t)),this.compute(t),this.computeInitial(),this.emit()}moveChange(t){if(!this.state._active)return;const s=Gt(t),c=this.state;c._delta=Ne.sub(s,c._values),Ne.addTo(c._movement,c._delta),this.computeValues(s),this.compute(t),this.emit()}moveEnd(t){this.state._active&&(this.state._active=!1,this.compute(t),this.emit())}bind(t){t("pointer","change",this.move.bind(this)),t("pointer","leave",this.moveEnd.bind(this))}}const g1=Pe(Pe({},Na),{},{mouseOnly:(o=!0)=>o});class b1 extends Lo{constructor(...t){super(...t),qe(this,"ingKey","scrolling")}scroll(t){this.state._active||this.start(t),this.scrollChange(t),this.timeoutStore.add("scrollEnd",this.scrollEnd.bind(this))}scrollChange(t){t.cancelable&&t.preventDefault();const s=this.state,c=Y_(t);s._delta=Ne.sub(c,s._values),Ne.addTo(s._movement,s._delta),this.computeValues(c),this.compute(t),this.emit()}scrollEnd(){this.state._active&&(this.state._active=!1,this.compute(),this.emit())}bind(t){t("scroll","",this.scroll.bind(this))}}const j1=Na;class v1 extends Lo{constructor(...t){super(...t),qe(this,"ingKey","wheeling")}wheel(t){this.state._active||this.start(t),this.wheelChange(t),this.timeoutStore.add("wheelEnd",this.wheelEnd.bind(this))}wheelChange(t){const s=this.state;s._delta=Wh(t),Ne.addTo(s._movement,s._delta),Vh(s),this.compute(t),this.emit()}wheelEnd(){this.state._active&&(this.state._active=!1,this.compute(),this.emit())}bind(t){t("wheel","",this.wheel.bind(this))}}const k1=Na;class _1 extends Lo{constructor(...t){super(...t),qe(this,"ingKey","hovering")}enter(t){this.config.mouseOnly&&t.pointerType!=="mouse"||(this.start(t),this.computeValues(Gt(t)),this.compute(t),this.emit())}leave(t){if(this.config.mouseOnly&&t.pointerType!=="mouse")return;const s=this.state;if(!s._active)return;s._active=!1;const c=Gt(t);s._movement=s._delta=Ne.sub(c,s._values),this.computeValues(c),this.compute(t),s.delta=s.movement,this.emit()}bind(t){t("pointer","enter",this.enter.bind(this)),t("pointer","leave",this.leave.bind(this))}}const A1=Pe(Pe({},Na),{},{mouseOnly:(o=!0)=>o}),lf=new Map,Hu=new Map;function C1(o){lf.set(o.key,o.engine),Hu.set(o.key,o.resolver)}const D1={key:"drag",engine:n1,resolver:m1},T1={key:"hover",engine:_1,resolver:A1},E1={key:"move",engine:p1,resolver:g1},S1={key:"pinch",engine:w1,resolver:h1},x1={key:"scroll",engine:b1,resolver:j1},G1={key:"wheel",engine:v1,resolver:k1};function O1(o,t){if(o==null)return{};var s={},c=Object.keys(o),u,d;for(d=0;d<c.length;d++)u=c[d],!(t.indexOf(u)>=0)&&(s[u]=o[u]);return s}function B1(o,t){if(o==null)return{};var s=O1(o,t),c,u;if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(o);for(u=0;u<d.length;u++)c=d[u],!(t.indexOf(c)>=0)&&Object.prototype.propertyIsEnumerable.call(o,c)&&(s[c]=o[c])}return s}const N1={target(o){if(o)return()=>"current"in o?o.current:o},enabled(o=!0){return o},window(o=Un.isBrowser?window:void 0){return o},eventOptions({passive:o=!0,capture:t=!1}={}){return{passive:o,capture:t}},transform(o){return o}},R1=["target","eventOptions","window","enabled","transform"];function wl(o={},t){const s={};for(const[c,u]of Object.entries(t))switch(typeof u){case"function":s[c]=u.call(s,o[c],c,o);break;case"object":s[c]=wl(o[c],u);break;case"boolean":u&&(s[c]=o[c]);break}return s}function M1(o,t,s={}){const c=o,{target:u,eventOptions:d,window:z,enabled:y,transform:h}=c,w=B1(c,R1);if(s.shared=wl({target:u,eventOptions:d,window:z,enabled:y,transform:h},N1),t){const v=Hu.get(t);s[t]=wl(Pe({shared:s.shared},w),v)}else for(const v in w){const k=Hu.get(v);k&&(s[v]=wl(Pe({shared:s.shared},w[v]),k))}return s}class Qh{constructor(t,s){qe(this,"_listeners",new Set),this._ctrl=t,this._gestureKey=s}add(t,s,c,u,d){const z=this._listeners,y=L_(s,c),h=this._gestureKey?this._ctrl.config[this._gestureKey].eventOptions:{},w=Pe(Pe({},h),d);t.addEventListener(y,u,w);const v=()=>{t.removeEventListener(y,u,w),z.delete(v)};return z.add(v),v}clean(){this._listeners.forEach(t=>t()),this._listeners.clear()}}class P1{constructor(){qe(this,"_timeouts",new Map)}add(t,s,c=140,...u){this.remove(t),this._timeouts.set(t,window.setTimeout(s,c,...u))}remove(t){const s=this._timeouts.get(t);s&&window.clearTimeout(s)}clean(){this._timeouts.forEach(t=>{window.clearTimeout(t)}),this._timeouts.clear()}}class H1{constructor(t){qe(this,"gestures",new Set),qe(this,"_targetEventStore",new Qh(this)),qe(this,"gestureEventStores",{}),qe(this,"gestureTimeoutStores",{}),qe(this,"handlers",{}),qe(this,"config",{}),qe(this,"pointerIds",new Set),qe(this,"touchIds",new Set),qe(this,"state",{shared:{shiftKey:!1,metaKey:!1,ctrlKey:!1,altKey:!1}}),J1(this,t)}setEventIds(t){if(xl(t))return this.touchIds=new Set(W_(t)),this.touchIds;if("pointerId"in t)return t.type==="pointerup"||t.type==="pointercancel"?this.pointerIds.delete(t.pointerId):t.type==="pointerdown"&&this.pointerIds.add(t.pointerId),this.pointerIds}applyHandlers(t,s){this.handlers=t,this.nativeHandlers=s}applyConfig(t,s){this.config=M1(t,s,this.config)}clean(){this._targetEventStore.clean();for(const t of this.gestures)this.gestureEventStores[t].clean(),this.gestureTimeoutStores[t].clean()}effect(){return this.config.shared.target&&this.bind(),()=>this._targetEventStore.clean()}bind(...t){const s=this.config.shared,c={};let u;if(!(s.target&&(u=s.target(),!u))){if(s.enabled){for(const z of this.gestures){const y=this.config[z],h=yw(c,y.eventOptions,!!u);if(y.enabled){const w=lf.get(z);new w(this,t,z).bind(h)}}const d=yw(c,s.eventOptions,!!u);for(const z in this.nativeHandlers)d(z,"",y=>this.nativeHandlers[z](Pe(Pe({},this.state.shared),{},{event:y,args:t})),void 0,!0)}for(const d in c)c[d]=V_(...c[d]);if(!u)return c;for(const d in c){const{device:z,capture:y,passive:h}=U_(d);this._targetEventStore.add(u,z,"",c[d],{capture:y,passive:h})}}}}function At(o,t){o.gestures.add(t),o.gestureEventStores[t]=new Qh(o,t),o.gestureTimeoutStores[t]=new P1}function J1(o,t){t.drag&&At(o,"drag"),t.wheel&&At(o,"wheel"),t.scroll&&At(o,"scroll"),t.move&&At(o,"move"),t.pinch&&At(o,"pinch"),t.hover&&At(o,"hover")}const yw=(o,t,s)=>(c,u,d,z={},y=!1)=>{var h,w;const v=(h=z.capture)!==null&&h!==void 0?h:t.capture,k=(w=z.passive)!==null&&w!==void 0?w:t.passive;let G=y?c:J_(c,u,v);s&&k&&(G+="Passive"),o[G]=o[G]||[],o[G].push(d)},F1=/^on(Drag|Wheel|Scroll|Move|Pinch|Hover)/;function U1(o){const t={},s={},c=new Set;for(let u in o)F1.test(u)?(c.add(RegExp.lastMatch),s[u]=o[u]):t[u]=o[u];return[s,t,c]}function Ct(o,t,s,c,u,d){if(!o.has(s)||!lf.has(c))return;const z=s+"Start",y=s+"End",h=w=>{let v;return w.first&&z in t&&t[z](w),s in t&&(v=t[s](w)),w.last&&y in t&&t[y](w),v};u[c]=h,d[c]=d[c]||{}}function L1(o,t){const[s,c,u]=U1(o),d={};return Ct(u,s,"onDrag","drag",d,t),Ct(u,s,"onWheel","wheel",d,t),Ct(u,s,"onScroll","scroll",d,t),Ct(u,s,"onPinch","pinch",d,t),Ct(u,s,"onMove","move",d,t),Ct(u,s,"onHover","hover",d,t),{handlers:d,config:t,nativeHandlers:c}}function K1(o,t={},s,c){const u=Ln.useMemo(()=>new H1(o),[]);if(u.applyHandlers(o,c),u.applyConfig(t,s),Ln.useEffect(u.effect.bind(u)),Ln.useEffect(()=>u.clean.bind(u),[]),t.target===void 0)return u.bind.bind(u)}function Z1(o){return o.forEach(C1),function(s,c){const{handlers:u,nativeHandlers:d,config:z}=L1(s,c||{});return K1(u,z,void 0,d)}}function W1(o,t){return Z1([D1,S1,x1,G1,E1,T1])(o,t||{})}const Y1=({parsedSongs:o,minZoom:t,maxZoom:s,defaultZoom:c,gesturesTarget:u})=>{const[d,z]=Ta("chosenSong",1),[y,h]=Ta("starredSongs",[]),[w,v]=Ta("onlyStarred",!1),[k,G]=Ta("selectedSong",null),[M,L]=Ta("zoomLevel",c),[U,ee]=B.useState(null),[q,W]=B.useState(null),I=y.length;B.useEffect(()=>{w&&(y.length?y.find($=>$===d)||z(y[0]):v(!1))},[w,v,d,z,y]);const ue=$=>{const Me=d===$,je=y.indexOf($),He=je+1,T=!!He,P=k===$;return{chosen:Me,starredNumber:He,starred:T,toggleStarred:()=>{G(T?J=>J===$?y.length<=1?null:y.length>je+1?y[je+1]:y[je-1]:J:$),h(J=>T?J.filter(ce=>ce!==$):[...J,$])},selected:P,toggleSelected:()=>G(P?null:$),moveUp:je<1?void 0:()=>h(J=>{const ce=J.filter(me=>me!==$);return ce.splice(je-1,0,$),ce}),moveDown:je>y.length-2?void 0:()=>h(J=>{const ce=J.filter(me=>me!==$);return ce.splice(je+1,0,$),ce})}},Y=$=>({...$,...ue($.number)}),Q=(w?y.flatMap($=>{const Me=o.find(je=>je.number===$);return Me?[Me]:[]}):o).map(Y),xe=$=>{const je=Q.findIndex(T=>T.chosen)-$,He=je>=Q.length?0:je<0?Q.length-1:je;z(Q[He].number)},Qe=$=>{ee($),W(M)},dn=$=>{if(U===null||q===null)return;const Me=$/U,je=Math.floor(Math.log10(Me)*10),He=Math.min(Math.max(t,q+je),s);L(He)};return W1({onDrag:({swipe:[$]})=>{$!==0&&xe($)},onPinch:({first:$,da:[Me]})=>{$&&Qe(Me),dn(Me)}},{target:u}),{songs:Q,setChosenSong:z,starredCount:I,onlyStarred:w,toggleOnlyStarred:()=>v($=>!$),zoomLevel:M}},q1=({parsedSongbook:o})=>{const t=B.useRef(null),{songs:s,setChosenSong:c,starredCount:u,onlyStarred:d,toggleOnlyStarred:z,zoomLevel:y}=Y1({parsedSongs:o.songs,minZoom:1,maxZoom:20,defaultZoom:5,gesturesTarget:t}),[h,w]=Ta("menuShown",!1),[v,k]=Ta("chordsShown",!0),G=()=>w(!0),M=()=>w(!1),L=()=>k(!0),U=()=>k(!1),ee=W=>{c(W),M()},q=s.find(W=>W.chosen);return N.jsxs(N.Fragment,{children:[!h&&N.jsx(x_,{onlyStarred:d,chordsShown:v,onClickMenu:G,onClickGuitar:v?U:L}),N.jsx("div",{ref:t,className:`container-lg pt-1 min-vh-100 bg-white songbook zoom-level-${y}`,children:!!q&&N.jsx(kb,{song:q,starredCount:u,chordsShown:v})}),N.jsx(S_,{songs:s,checksum:o.checksum,chooseSong:ee,starredCount:u,onlyStarred:d,toggleOnlyStarred:z,show:h,onClose:M})]})},X1=`1. Ty wyzwoliłeś nas Panie      [A] [D] [E] [A]
...
Sic nos amantem, quis non redamaret?
`,Q1=`Albowiem tak Bóg umiłował świat, [e7/9] [C] [D] [h7]
...
Ref. Alleluja…
`,$1=`Alleluja, alleluja, alleluja, alleluuuuja! |2x [A] [D] [A] [D] [E] [A]
...
`,pA=`Ref. Chrystus Pan karmi nas [e] [C] [h7]
...
`,gA=`Chwała Bogu Ojcu, w chwale Jego Syn [e] [D] [e] [D]
...
`,ZA=`1. Duszo Chrystusowa, uświęć mnie.      [d] [a] [d]
...
Na wieki wieków. Amen.                  [d] [C] [a] [C] [d]`,WA=`Ref. Duszo ma, Pana chwal,  [G] [D]
...
`,QA=`1. Dzisiaj w Betlejem, dzisiaj w Betlejem wesoła nowina [D] [A]
...
`,IA=`1. Wielkie światło, które dałeś [D]
...
Fundamentem jest miłość. [e] [C]
 [cis7/5-] [C7+] [e7/9]
`,eC=`1. Gdy się Chrystus rodzi, [C] [F] [C]
...
`,iC=`Ref. Gloria in excelsis Deo, Gloria, Gloria! [A] [cis] [D] [E] [E7]
...
`,tC=`1. Godzien chwały jest Baranek [C] [g]
...
`,sC=`1. Golgoto, Golgoto, Golgoto! [g] [c] [F] [B] [D7]
...
Ref. To nie gwoździe Cię przybiły…
`,lC=`1. Gore gwiazda Jezusowi        [d] [F]
...
`,cC=`1. Hosanna, hosanna, hosanna na niebiosach. [D] [A] [h] [G] [A]
...
`,rC=`O Stworzycielu, Duchu, przyjdź,
...
Ref. Oto ja - służebnica Pańska...
`,fC=`Ref. Idzie mój Pan, idzie mój Pan [d]
...
`,dC=`1. Patrzę w moje serce, widzę krew i rany [cis] [H] [E]
...
`,mC=`1. Panie, dla Ciebie nie ma rzeczy [E7+]
niemożliwych. [A]
...
`,zC=`1. Ja wierzę, że to Jezus [E] [A] [H7]
...
`,yC=`1. Tyle światła wokół mnie, [Es-sus2]
...
Ref. Jahwe – Ty jesteś światłem…
`,wC=`Jak dobrze jest dziękować Ci Panie [a7] [d7]
...
`,hC=`Ref. Jak w Betlejem cud zdarzył się     [d] [C]
...
Ło ło, ło ło ło ło                      [d]
`,pC=`1. Ty na początku byłeś Słowem     [C]
...
Solo gitara [A7] [D7] [G] [C] [|x3]
 [F] [G] [|x2]
`,bC=`Jego Miłość zakrywa grzech [e] [h]
...
`,kC=`1. Jestem dzieckiem Boga, [a7] [e7]
...
`,_C=`Jestem tego pewien, nic nie oddzieli nas    [a7/9]
...
`,AC=`1. Ty światłość dnia wszedłeś [E] [H]
...
`,CC=`Jesteś Królem, jesteś Królem [E] [H7] [cis]
...
`,DC=`Ref. Jesteś perłą w życiu mym [E]
...
Ty otwierasz nasze oczy, Panie, [g7] [d7] [C]
na Twoje piękno! [F]
`,EC=`Jezu jesteś tu                  [A] [E/Gis] [fis] [fis/E]
...
`,SC=`Jezu, Tyś wszystkim dla mnie jest, [D] [Asus4] [G] [A]
...
Otworzyło się, obmywając z grzechów mnie.
 [d] [C] [B7+] [C] [(Dadd9)]
`,GC=`1. Jezus daje nam zbawienie     [d] [C] [a] [d]
...
Daj mi dłoń [C] [e/H] [a7] [Gsus4]
 [F] [As] [G] [C7+]
`,BC=`/x3/ Jezus jest z nami tu [B] [C] [F] [d]
...
`,MC=`Jezus, najwyższe Imię [D] [D7+] [D6] [D7+]
...
`,PC=`Jezus, Jezus, Jezus, Jezus, Jezus [D] [E7] [G] [A7] [D]

Ref. Pokonał śmierć, pokonał mój grzech [G] [D]
Zmartwychwstał Pan i Królem jest [G] [D]
 [G] [D] [G] [A] [D]
`,HC=`Ref. Jezus uzdrawia dziś. Alleluja! [e] [G] [a] [H7]
...
`,JC=`1. Jezusa narodzonego wszyscy witajmy, [D] [G] [D] [A] [A7] [D]
...
`,FC=`Już teraz we mnie kwitną Twe ogrody, [C] [F] [G]
już teraz we mnie Twe królestwo jest. x2 [F] [d] [G] [(C)]
`,UC=`1. My, którzy wszystko liczymy, [h]
...
Ref. Każdy wschód słońca…
`,LC=`Ref: Kiedyś wino i chleb [D] [G] [A]
...
Ref: Kiedyś wino i chleb…
`,KC=`1. Kocham Twoją wolę Panie, [h] [Fis]
...
`,ZC=`1. Kocham, więc nie muszę się bać [H]
...
Ref. Takie jest prawo miłości…
`,YC=`Ojcze nasz, Zdrowaś Maryjo, Wierzę w Boga
...
`,qC=`1. Krzyżu Święty, co świat obejmujesz, [d] [A7] [d]
...
Zmiłuj się nad nami.
`,XC=`Łaską jesteśmy zbawieni [A] [fis]
...
`,VC=`Ref.: Lud Twój, Panie, lud pielgrzymi [D] [A] [h] [D7]
...
Ref. Lud Twój, Panie…
`,QC=`1. Lulajże Jezuniu, moja perełko, [C] [d] [G] [C]
...
`,IC=`Maryjo, chcę zamieszkać z Tobą,     [F] [C]
...
`,$C=`1. Maryjo, Matko mojego wezwania [G] [H]
...
Bądź! [fis] [A2] [H4] [E]
`,nD=`Maryjo, wzorze prostoty, [E] [fis7/11] [cis7/9]
...
`,iD=`1. Mędrcy świata Monarchowie,     [A] [D] [A]
...
`,aD=`Ref. Alleluja, alleluja,            [B] [C] [a] [B]
Alleluja amen                       [g] [a] [G]
...
Ref. Śpiewam… Dlatego śpiewam
`,lD=`1. Mizerna, cicha, stajenka licha, [a] [h7/5-] [a] [E7]
...
`,cD=`1. Zabierz, Panie, i przyjmij [a] [G]
...
`,rD=`Przymnóż nam wiary, Panie       [fis] [E/Gis] [fis/A] [hsus2]
...
`,fD=`1.Twoje ręce to mój ląd, wiem nie utonę [a] [F] [C]
...
`,mD=`1. Moje wędrowanie, moje upadanie, [D] [E] [A] [D] [E] [fis]
...
`,yD=`(Solo gitara x2)                    [fis] [E] [cis] [D7+]
                                    [h] [cis] [E] [fis] [(E)]
...
Wiele możesz zdziałać.              [h] [cis] [D7+]
                                    [fis] [E] [fis]
`,wD=`1. Mroźna cisza świat okryła [h] [e]
...
Luli, la-a-aj…
`,hD=`Ref. Nadzieja nosi niebieską sukienkę, [D] [G7+] [h]
...
Ref. Nadzieja nosi niebieską sukienkę…
`,pD=`Ref. Narodził się, narodził się,  [D] [A] [e] [h]
...
`,AD=`Nie bójcie się żyć dla miłości [e] [C] [a] [D]
Dla tej miłości warto żyć [e] [D] [e] [D]
`,CD=`Nie chcę w innym miejscu być [D]
...
`,DD=`Nie lękajcie się, Ja jestem z wami.         [C] [F] [G] [C] [F] [G]
...
`,TD=`Ref. Nie mądrość świata tego,
...
`,ED=`Ref.: Nie, nie, nie lękaj się [A] [D] [E]
...
W Tobie nadzieja ma.
`,BD=`1. Niech wam błogosławi Pan [H] [E] [H] [E]
...
Niech wam błogosławi Pan [a] [G] [C] [F]
 [a] [G] [C] [F]
 [a] [G] [F]
`,ND=`Ref. x2 Alleluja, Alleluja,     [fis] [E]
...
`,RD=`Niechaj zstąpi Duch Twój i odnowi ziemię [e]
...
`,MD=`Ref. Niegodny jestem Panie [d]
...
`,HD=`1. Otwarta na Boga, odwiecznie wybrana  [e]
...
`,JD=`O Jezu, cichy i pokorny         [d] [a] [d] [a]
Uczyń serce me                  [F] [a]
...
`,LD=`1. O, Panie, Ty nam dajesz [d] [F]
...
`,ZD=`O Zbawcza Hostio godna czci,
...
`,WD=`1. Znad oceanów do mnie wołasz [h] [A/Cis] [D]
...
Dla duszy pokój w Tobie jest [G] [D] [A]
Gdzie pójdziesz Ty, ja pójdę też [G] [A]
`,YD=`Ref. Oddaję Ci życie swe [D] [e]
...
Ref. Daj Ducha świętego mi…
`,qD=`Oddajmy cześć wiecznemu Panu chwał, [h] [e] [fis] [h]
...
`,VD=`Ofiaruję Tobie, Panie mój,              [C] [G] [a]
Całe życie me,                          [e] [F]
...
`,QD=`Ojcze nasz, który jesteś w niebie [B] [F] [g7] [d]
...
Z głębi serca dziś wołam: Maranatha /x2 [A] [H7] [cis]
 [A] [H7] [E]
`,$D=`Ref. Oto ja, poślij mnie. [E] [A] [H7]
...
Ref. Oto ja, poślij mnie…
`,e2=`Ref. Oto są baranki młode, oto ci, co zawołali: alleluja!
...
Ref. Oto są baranki młode…
`,n2=`1. Usłyszałem i ujrzałem [A] [A4/3]
...
`,o2=`Pan jest mocą Swojego ludu          [F] [B] [C7]
...
`,s2=`Pan jest Pasterzem moim, [h] [e] [G] [A] [h]
...
pocieszają. [h]
`,l2=`Pan mnie strzeże, Pan mnie strzeże. Czuwa [E] [A]
...
`,r2=`Panie mój, przychodzę dziś,     [D] [G]
...
`,u2=`Panie, Twój tron wznosi się [e] [A]
...
`,z2=`1. Pastuszkowie bracia mili [F]
...
`,y2=`1. Pełen czci przed Tobą klękam    [G] [D]
...
`,w2=`1. Po szabacie pierwszego dnia z rana [e] [C]
...
`,g2=`2x: Pokorna Służebnico Pana [g] [F]
...
`,j2=`Powietrzem moim Jest x2 [F] [B] [F] [B]
...
`,v2=`1. Powstań i świeć oto tutaj twe światło, [d] [A]
...
`,_2=`1. Prawda jedyna słowa Jezusa z Nazaretu, [D] [A] [fis] [cis]
...
`,A2=`Przed Tobą, Wszechmocny,    [B] [F/A]
...
`,C2=`1. Przybądź Duchu Święty, ześlij z nieba wzięty [d] [C] [B]
...
daj szczęście bez miary! [C] [F] [B] [C]
`,D2=`1. Języku ognia przyjdź [H2] [D2]
...
4. Dziwili się napowietrznej muzyce
i myśleli, co to będzie za Dziecię?
`,S2=`Przyjaciela mam, co pociesza mnie, [C] [G] [a] [F]
...
Jezus, Jezus
`,x2=`Przyjacielu, przyjacielu    [G] [e]
...
`,G2=`1. Przyjdź jak deszcz ożyw dziś [cis] [A]
...
`,O2=`1. Przyjdź, królestwo Twoje [D] [A] [h]
...
`,M2=`Ref.: Śpiewajcie Panu, bo wielka Jego moc i chwała!
...
`,P2=`Raduje się dusza ma, wielbi Pana swego [fis]
...
Pan mój Zbawca [Cis]
`,H2=`Ref. Rozpięty na ramionach [a] [C] [G]
...
Ref.: Rozpięty…
`,J2=`Rzekł Pan, stało się: Jam Alfa i Omega [D] [Asus4] [A] [e7]
...
`,L2=`1. Skrzypi wóz, wielki mróz,  [F] [B]
...
`,K2=`1. Światłość świata rozjaśnia mrok      [c] [As] [B] [f]
...
`,Z2=`1. Śpiewaj Panu, swemu Bogu [D]
...
`,Y2=`Spocznij na nas, Duchu Pana, [D] [A] [G] [e7]
...
Ref. Znalazłem Cię…
`,I2=`Ref. x2 Szukam Cię, Panie, [cis] [gis]
o wschodzie [A] [H]
...
Taki jesteś Ty...
`,nT=`Ref. To jest Baranka Ciało, Jego Krew [fis] [cis]
...
`,oT=`Ty masz moc uzdrowienia, Jezu. [A] [G/A]
...
`,sT=`1. Gdy drogi pomyli los zły [G] [C7+]
...
(Solo skrzypce)         [D] [A] [h]
                        ...
                        [G] [D] [G] [A7]
                        [D]
`,cT=`Ukaż mi, Panie, Swą twarz. [D] [G] [D] [G]
...
`,rT=`1. Tylko w Bogu moje jest zbawienie. [D7+] [E] [fis4-3]
...
`,pT=`W Swym Sercu na wieki ukryłeś nas, [e] [A] [G] [A]
...
Ref. Jezu, Serce Twoje….
`,gT=`Ref. Aaa, alleluja, w Tobie cała nadzieja ma [f] [b] [C]
...
`,bT=`W Tobie jest światło, każdy mrok rozjaśni. [h] [A] [G] [D] [fis7]
...
`,vT=`1. W żłobie leży, któż pobieży          [D] [A]
...
`,kT=`1. W żłobie leży, któż pobieży          [D] [e] [A7]
...
Pod nieba Empirejskie.
                                        [Fis7] [G] [g6] [A7] [D]
`,_T=`Więcej miłości, więcej mocy [e] [C]
...
potężniejsza jest.      [G] [A] [D]
 ...
 ---
`,DT=`1. Wspaniały Dawco miłości, [D] [G] [D] [G]
...
`,TT=`1. Wśród nocnej ciszy           [D] [A] [D] [A7]
...
`,ET=`Wszyscy ludzie klaszczą w dłonie [C] [G] [D] [e7]
...
Wszyscy ludzie… Nadejdzie dzień…
`,ST=`Wszystkie narody klaskajcie w dłonie [D]
...
`,xT=`Ref. Wszystko, co dziś mamy [A] [cis]
...
jest Królem całej ziemi.       [d]
Bóg Abrahama                   [d]
`,OT=`Ref. Wykrzykujcie na cześć Pana [e] [C]
...
`,BT=`Ref. Wypłyń na głębię /x2 [G] [A] [D] [h]
...
`,NT=`Ref. Yeshua, Yeshua [g] [d] [Es] [F] [g]
...
`,RT=`Ty, który jesteś samą Prawdą, [Es] [F] [g]
...
W chwale Ojca [G]
`,MT=`1. Z Narodzenia Pana dzień dziś wesoły. [D] [G] [A] [D]
...
`,PT=`1. 2x Z okrzykiem radości [G] [D]
...
`,HT=`Z Tobą ciemność nie będzie ciemna [E] [a] [G] [C]
Wokół mnie [F] [E]
A noc tak jak dzień zajaśnieje [a] [G] [C] [d] [E]
`,JT=`1. Za to, że mnie ukochałeś [D] [h]
...
`,FT=`Ref. Zaśpiewajcie Panu pieśń nową [D] [E] [fis]
...
Ref.2x Jeżeli chcesz Mnie naśladować...
`,KT=`1. Zbliżam się w pokorze i niskości swej. [C] [G] [a]
...
`,ZT=`Ref. Zbudowani na Chrystusie [C] [G]
...
`,YT=`Ref. Zmartwychwstał Pan i żyje dziś, [e] [C] [G]
...
`,qT=`1. Zwykły chleb przemieniasz, Panie, [E]
w Ciało Swe, [A] [E] [(A] [E)]
...
Bóg wywiedzie życie
Jak wtedy o świcie
`,VT=`1. Ten którego pocałuję w twarz, [d] [C]
