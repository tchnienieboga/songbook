...
`,b2=`2x: Pokorna Służebnico Pana [g] [F]
...
`,v2=`Powietrzem moim Jest x2 [F] [B] [F] [B]
...
`,k2=`1. Powstań i świeć oto tutaj twe światło, [d] [A]
...
`,A2=`1. Prawda jedyna słowa Jezusa z Nazaretu, [D] [A] [fis] [cis]
...
`,C2=`Przed Tobą, Wszechmocny,    [B] [F/A]
...
`,D2=`1. Przybądź Duchu Święty, ześlij z nieba wzięty [d] [C] [B]
...
daj szczęście bez miary! [C] [F] [B] [C]
`,T2=`1. Języku ognia przyjdź [H2] [D2]
...
4. Dziwili się napowietrznej muzyce
i myśleli, co to będzie za Dziecię?
`,x2=`Przyjaciela mam, co pociesza mnie, [C] [G] [a] [F]
...
Jezus, Jezus
`,G2=`Przyjacielu, przyjacielu    [G] [e]
...
`,O2=`1. Przyjdź jak deszcz ożyw dziś [cis] [A]
...
`,B2=`1. Przyjdź, królestwo Twoje [D] [A] [h]
...
`,P2=`Ref.: Śpiewajcie Panu, bo wielka Jego moc i chwała!
...
`,H2=`Raduje się dusza ma, wielbi Pana swego [fis]
...
Pan mój Zbawca [Cis]
`,J2=`Ref. Rozpięty na ramionach [a] [C] [G]
...
Ref.: Rozpięty…
`,F2=`Rzekł Pan, stało się: Jam Alfa i Omega [D] [Asus4] [A] [e7]
...
`,Z2=`1. Światłość świata rozjaśnia mrok      [c] [As] [B] [f]
...
`,W2=`1. Śpiewaj Panu, swemu Bogu [D]
...
`,q2=`Spocznij na nas, Duchu Pana, [D] [A] [G] [e7]
...
Ref. Znalazłem Cię…
`,$2=`Ref. x2 Szukam Cię, Panie, [cis] [gis]
o wschodzie [A] [H]
...
Taki jesteś Ty...
`,iT=`Ref. To jest Baranka Ciało, Jego Krew [fis] [cis]
...
`,sT=`Ty masz moc uzdrowienia, Jezu. [A] [G/A]
...
`,lT=`1. Gdy drogi pomyli los zły [G] [C7+]
...
(Solo skrzypce)         [D] [A] [h]
                        ...
                        [G] [D] [G] [A7]
                        [D]
`,rT=`Ukaż mi, Panie, Swą twarz. [D] [G] [D] [G]
...
`,uT=`1. Tylko w Bogu moje jest zbawienie. [D7+] [E] [fis4-3]
...
Tylko w Bogu moje jest zbawienie.      [E7+] [Fis] [gis]
                                       [E7+] [Fis] [Gis]
`,fT=`1. Upadnij na kolana,           [e] [H] [e] [H7]
...
Ref. Jezu, Serce Twoje….
`,bT=`Ref. Aaa, alleluja, w Tobie cała nadzieja ma [f] [b] [C]
...
`,jT=`W Tobie jest światło, każdy mrok rozjaśni. [h] [A] [G] [D] [fis7]
...
`,kT=`1. W żłobie leży, któż pobieży          [D] [A]
...
`,_T=`1. W żłobie leży, któż pobieży          [D] [e] [A7]
...
Pod nieba Empirejskie.
                                        [Fis7] [G] [g6] [A7] [D]
`,AT=`Więcej miłości, więcej mocy [e] [C]
...
potężniejsza jest.      [G] [A] [D]
 ...
 ---
`,TT=`1. Wspaniały Dawco miłości, [D] [G] [D] [G]
...
`,ET=`1. Wśród nocnej ciszy           [D] [A] [D] [A7]
...
`,ST=`Wszyscy ludzie klaszczą w dłonie [C] [G] [D] [e7]
...
Wszyscy ludzie… Nadejdzie dzień…
`,xT=`Wszystkie narody klaskajcie w dłonie [D]
...
`,GT=`Ref. Wszystko, co dziś mamy [A] [cis]
...
jest Królem całej ziemi.       [d]
Bóg Abrahama                   [d]
`,BT=`Ref. Wykrzykujcie na cześć Pana [e] [C]
...
`,NT=`Ref. Wypłyń na głębię /x2 [G] [A] [D] [h]
...
`,RT=`Ref. Yeshua, Yeshua [g] [d] [Es] [F] [g]
...
`,MT=`Ty, który jesteś samą Prawdą, [Es] [F] [g]
...
W chwale Ojca [G]
`,PT=`1. Z Narodzenia Pana dzień dziś wesoły. [D] [G] [A] [D]
...
`,HT=`1. 2x Z okrzykiem radości [G] [D]
...
`,JT=`Z Tobą ciemność nie będzie ciemna [E] [a] [G] [C]
Wokół mnie [F] [E]
A noc tak jak dzień zajaśnieje [a] [G] [C] [d] [E]
`,FT=`1. Za to, że mnie ukochałeś [D] [h]
...
`,UT=`Ref. Zaśpiewajcie Panu pieśń nową [D] [E] [fis]
...
Ref.2x Jeżeli chcesz Mnie naśladować...
`,ZT=`1. Zbliżam się w pokorze i niskości swej. [C] [G] [a]
...
`,WT=`Ref. Zbudowani na Chrystusie [C] [G]
...
`,qT=`Ref. Zmartwychwstał Pan i żyje dziś, [e] [C] [G]
...
`,XT=`1. Zwykły chleb przemieniasz, Panie, [E]
w Ciało Swe, [A] [E] [(A] [E)]
...
Bóg wywiedzie życie
Jak wtedy o świcie
`,QT=`1. Ten którego pocałuję w twarz, [d] [C]
