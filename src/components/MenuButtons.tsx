        ...
        <div className="sb-menu-buttons-container">
            <div
                className={classNames(
                    ...
                    'shadow',
                    'rounded-circle',
                    chordsShown ? 'sb-menu-button-red' : 'sb-menu-button-gray',
                    'd-flex',
                ...
                tabIndex={0}
                role="button"
                onClick={onClickGuitar}>
                <div className="sb-menu-button-icon my-auto">
                    <FontAwesomeIcon icon={faGuitar} size="lg" />
                </div>
            </div>
            <div
                className="btn sb-menu-button shadow rounded-circle sb-menu-button-cyan d-flex justify-content-center align-items-center pt-2"
                tabIndex={1}
                role="button"
                onClick={onClickMenu}>
                <div className="sb-menu-button-icon my-auto">
